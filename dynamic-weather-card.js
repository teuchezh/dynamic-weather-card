var m=function(i,o,a,n){var e=arguments.length,r=e<3?o:n===null?n=Object.getOwnPropertyDescriptor(o,a):n,l;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")r=Reflect.decorate(i,o,a,n);else for(var s=i.length-1;s>=0;s--)if(l=i[s])r=(e<3?l(r):e>3?l(o,a,r):l(o,a))||r;return e>3&&r&&Object.defineProperty(o,a,r),r};var ni=globalThis,fi=ni.ShadowRoot&&(ni.ShadyCSS===void 0||ni.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,pi=Symbol(),io=new WeakMap;class zi{constructor(i,o,a){if(this._$cssResult$=!0,a!==pi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=i,this._strings=o}get styleSheet(){let i=this._styleSheet,o=this._strings;if(fi&&i===void 0){let a=o!==void 0&&o.length===1;if(a)i=io.get(o);if(i===void 0){if((this._styleSheet=i=new CSSStyleSheet).replaceSync(this.cssText),a)io.set(o,i)}}return i}toString(){return this.cssText}}var sa=(i)=>{if(i._$cssResult$===!0)return i.cssText;else if(typeof i==="number")return i;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${i}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},ta=(i)=>new zi(typeof i==="string"?i:String(i),void 0,pi),T=(i,...o)=>{let a=i.length===1?i[0]:o.reduce((n,e,r)=>n+sa(e)+i[r+1],i[0]);return new zi(a,i,pi)},oo=(i,o)=>{if(fi)i.adoptedStyleSheets=o.map((a)=>a instanceof CSSStyleSheet?a:a.styleSheet);else for(let a of o){let n=document.createElement("style"),e=ni.litNonce;if(e!==void 0)n.setAttribute("nonce",e);n.textContent=a.cssText,i.appendChild(n)}},da=(i)=>{let o="";for(let a of i.cssRules)o+=a.cssText;return ta(o)},vi=fi?(i)=>i:(i)=>i instanceof CSSStyleSheet?da(i):i;var{is:ca,defineProperty:ua,getOwnPropertyDescriptor:ao,getOwnPropertyNames:ga,getOwnPropertySymbols:_a,getPrototypeOf:no}=Object,ha=!1,M=globalThis;if(ha)M.customElements??=customElements;var P=!0,H,eo=M.trustedTypes,ka=eo?eo.emptyScript:"",lo=P?M.reactiveElementPolyfillSupportDevMode:M.reactiveElementPolyfillSupport;if(P)M.litIssuedWarnings??=new Set,H=(i,o)=>{if(o+=` See https://lit.dev/msg/${i} for more information.`,!M.litIssuedWarnings.has(o)&&!M.litIssuedWarnings.has(i))console.warn(o),M.litIssuedWarnings.add(o)},queueMicrotask(()=>{if(H("dev-mode","Lit is in dev mode. Not recommended for production!"),M.ShadyDOM?.inUse&&lo===void 0)H("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var ya=P?(i)=>{if(!M.emitLitDebugLogEvents)return;M.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))}:void 0,x=(i,o)=>i,G={toAttribute(i,o){switch(o){case Boolean:i=i?ka:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i);break}return i},fromAttribute(i,o){let a=i;switch(o){case Boolean:a=i!==null;break;case Number:a=i===null?null:Number(i);break;case Object:case Array:try{a=JSON.parse(i)}catch(n){a=null}break}return a}},ei=(i,o)=>!ca(i,o),ro={attribute:!0,type:String,converter:G,reflect:!1,useDefault:!1,hasChanged:ei};Symbol.metadata??=Symbol("metadata");M.litPropertyMetadata??=new WeakMap;class F extends HTMLElement{static addInitializer(i){this.__prepare(),(this._initializers??=[]).push(i)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(i,o=ro){if(o.state)o.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(i))o=Object.create(o),o.wrapped=!0;if(this.elementProperties.set(i,o),!o.noAccessor){let a=P?Symbol.for(`${String(i)} (@property() cache)`):Symbol(),n=this.getPropertyDescriptor(i,a,o);if(n!==void 0)ua(this.prototype,i,n)}}static getPropertyDescriptor(i,o,a){let{get:n,set:e}=ao(this.prototype,i)??{get(){return this[o]},set(r){this[o]=r}};if(P&&n==null){if("value"in(ao(this.prototype,i)??{}))throw Error(`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);H("reactive-property-without-getter",`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:n,set(r){let l=n?.call(this);e?.call(this,r),this.requestUpdate(i,l,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(i){return this.elementProperties.get(i)??ro}static __prepare(){if(this.hasOwnProperty(x("elementProperties",this)))return;let i=no(this);if(i.finalize(),i._initializers!==void 0)this._initializers=[...i._initializers];this.elementProperties=new Map(i.elementProperties)}static finalize(){if(this.hasOwnProperty(x("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(x("properties",this))){let o=this.properties,a=[...ga(o),..._a(o)];for(let n of a)this.createProperty(n,o[n])}let i=this[Symbol.metadata];if(i!==null){let o=litPropertyMetadata.get(i);if(o!==void 0)for(let[a,n]of o)this.elementProperties.set(a,n)}this.__attributeToPropertyMap=new Map;for(let[o,a]of this.elementProperties){let n=this.__attributeNameForProperty(o,a);if(n!==void 0)this.__attributeToPropertyMap.set(n,o)}if(this.elementStyles=this.finalizeStyles(this.styles),P){if(this.hasOwnProperty("createProperty"))H("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))H("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(i){let o=[];if(Array.isArray(i)){let a=new Set(i.flat(1/0).reverse());for(let n of a)o.unshift(vi(n))}else if(i!==void 0)o.push(vi(i));return o}static __attributeNameForProperty(i,o){let a=o.attribute;return a===!1?void 0:typeof a==="string"?a:typeof i==="string"?i.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((i)=>this.enableUpdating=i),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((i)=>i(this))}addController(i){if((this.__controllers??=new Set).add(i),this.renderRoot!==void 0&&this.isConnected)i.hostConnected?.()}removeController(i){this.__controllers?.delete(i)}__saveInstanceProperties(){let i=new Map,o=this.constructor.elementProperties;for(let a of o.keys())if(this.hasOwnProperty(a))i.set(a,this[a]),delete this[a];if(i.size>0)this.__instanceProperties=i}createRenderRoot(){let i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return oo(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((i)=>i.hostConnected?.())}enableUpdating(i){}disconnectedCallback(){this.__controllers?.forEach((i)=>i.hostDisconnected?.())}attributeChangedCallback(i,o,a){this._$attributeToProperty(i,a)}__propertyToAttribute(i,o){let n=this.constructor.elementProperties.get(i),e=this.constructor.__attributeNameForProperty(i,n);if(e!==void 0&&n.reflect===!0){let l=(n.converter?.toAttribute!==void 0?n.converter:G).toAttribute(o,n.type);if(P&&this.constructor.enabledWarnings.includes("migration")&&l===void 0)H("undefined-attribute-value",`The attribute value for the ${i} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=i,l==null)this.removeAttribute(e);else this.setAttribute(e,l);this.__reflectingProperty=null}}_$attributeToProperty(i,o){let a=this.constructor,n=a.__attributeToPropertyMap.get(i);if(n!==void 0&&this.__reflectingProperty!==n){let e=a.getPropertyOptions(n),r=typeof e.converter==="function"?{fromAttribute:e.converter}:e.converter?.fromAttribute!==void 0?e.converter:G;this.__reflectingProperty=n;let l=r.fromAttribute(o,e.type);this[n]=l??this.__defaultValues?.get(n)??l,this.__reflectingProperty=null}}requestUpdate(i,o,a,n=!1,e){if(i!==void 0){if(P&&i instanceof Event)H("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let r=this.constructor;if(n===!1)e=this[i];if(a??=r.getPropertyOptions(i),(a.hasChanged??ei)(e,o)||a.useDefault&&a.reflect&&e===this.__defaultValues?.get(i)&&!this.hasAttribute(r.__attributeNameForProperty(i,a)))this._$changeProperty(i,o,a);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(i,o,{useDefault:a,reflect:n,wrapped:e},r){if(a&&!(this.__defaultValues??=new Map).has(i)){if(this.__defaultValues.set(i,r??o??this[i]),e!==!0||r!==void 0)return}if(!this._$changedProperties.has(i)){if(!this.hasUpdated&&!a)o=void 0;this._$changedProperties.set(i,o)}if(n===!0&&this.__reflectingProperty!==i)(this.__reflectingProperties??=new Set).add(i)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(o){Promise.reject(o)}let i=this.scheduleUpdate();if(i!=null)await i;return!this.isUpdatePending}scheduleUpdate(){let i=this.performUpdate();if(P&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof i?.then==="function")H("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return i}performUpdate(){if(!this.isUpdatePending)return;if(ya?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),P){let e=[...this.constructor.elementProperties.keys()].filter((r)=>this.hasOwnProperty(r)&&(r in no(this)));if(e.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${e.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[n,e]of this.__instanceProperties)this[n]=e;this.__instanceProperties=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[n,e]of a){let{wrapped:r}=e,l=this[n];if(r===!0&&!this._$changedProperties.has(n)&&l!==void 0)this._$changeProperty(n,void 0,e,l)}}let i=!1,o=this._$changedProperties;try{if(i=this.shouldUpdate(o),i)this.willUpdate(o),this.__controllers?.forEach((a)=>a.hostUpdate?.()),this.update(o);else this.__markUpdated()}catch(a){throw i=!1,this.__markUpdated(),a}if(i)this._$didUpdate(o)}willUpdate(i){}_$didUpdate(i){if(this.__controllers?.forEach((o)=>o.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(i);if(this.updated(i),P&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))H("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(i){return!0}update(i){this.__reflectingProperties&&=this.__reflectingProperties.forEach((o)=>this.__propertyToAttribute(o,this[o])),this.__markUpdated()}updated(i){}firstUpdated(i){}}F.elementStyles=[];F.shadowRootOptions={mode:"open"};F[x("elementProperties",F)]=new Map;F[x("finalized",F)]=new Map;lo?.({ReactiveElement:F});if(P){F.enabledWarnings=["change-in-update","async-perform-update"];let i=function(o){if(!o.hasOwnProperty(x("enabledWarnings",o)))o.enabledWarnings=o.enabledWarnings.slice()};F.enableWarning=function(o){if(i(this),!this.enabledWarnings.includes(o))this.enabledWarnings.push(o)},F.disableWarning=function(o){i(this);let a=this.enabledWarnings.indexOf(o);if(a>=0)this.enabledWarnings.splice(a,1)}}(M.reactiveElementVersions??=[]).push("2.1.2");if(P&&M.reactiveElementVersions.length>1)queueMicrotask(()=>{H("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var S=globalThis,h=(i)=>{if(!S.emitLitDebugLogEvents)return;S.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))},ma=0,U;S.litIssuedWarnings??=new Set,U=(i,o)=>{if(o+=i?` See https://lit.dev/msg/${i} for more information.`:"",!S.litIssuedWarnings.has(o)&&!S.litIssuedWarnings.has(i))console.warn(o),S.litIssuedWarnings.add(o)},queueMicrotask(()=>{U("dev-mode","Lit is in dev mode. Not recommended for production!")});var A=S.ShadyDOM?.inUse&&S.ShadyDOM?.noPatch===!0?S.ShadyDOM.wrap:(i)=>i,ri=S.trustedTypes,so=ri?ri.createPolicy("lit-html",{createHTML:(i)=>i}):void 0,wa=(i)=>i,di=(i,o,a)=>wa,fa=(i)=>{if(q!==di)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");q=i},pa=()=>{q=di},Si=(i,o,a)=>{return q(i,o,a)},ko="$lit$",D=`lit$${Math.random().toFixed(9).slice(2)}$`,yo="?"+D,za=`<${yo}>`,J=document,L=()=>J.createComment(""),X=(i)=>i===null||typeof i!="object"&&typeof i!="function",ji=Array.isArray,va=(i)=>ji(i)||typeof i?.[Symbol.iterator]==="function",bi=`[ 	
\f\r]`,ba=`[^ 	
\f\r"'\`<>=]`,Ma=`[^\\s"'>=/]`,V=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,to=1,Mi=2,Pa=3,co=/-->/g,uo=/>/g,C=new RegExp(`>|${bi}(?:(${Ma}+)(${bi}*=${bi}*(?:${ba}|("|')|))|$)`,"g"),Fa=0,go=1,Sa=2,_o=3,Pi=/'/g,Fi=/"/g,mo=/^(?:script|style|textarea|title)$/i,ja=1,li=2,si=3,Hi=1,ti=2,Ha=3,Aa=4,Na=5,Ai=6,Da=7,Ni=(i)=>(o,...a)=>{if(o.some((n)=>n===void 0))console.warn(`Some template strings are undefined.
...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:i,strings:o,values:a}},u=Ni(ja),k=Ni(li),wn=Ni(si),W=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),ho=new WeakMap,B=J.createTreeWalker(J,129),q=di;function wo(i,o){if(!ji(i)||!i.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`,rn={sunny:k`
  ...
  `};function oi(i,...o){let a=en[i];if(typeof a==="function")return a(...o);return a||""}function hi(i){if(!i)return"";return rn[i.toLowerCase()]||""}class Io extends v{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null;this.compact=!1}static styles=T`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return u``;return u`
    ...
    `}renderSunrise(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunrise)return u``;return u`
      <div class="info-item">
        ...
        <span>${Zi(this.sunData.sunrise,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
    ...
    `}renderSunset(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunset)return u``;return u`
      <div class="info-item">
        ...
        <span>${Zi(this.sunData.sunset,this.config.clockFormat,d.t("am"),d.t("pm"))}</span>
      </div>
...
`;class Eo extends v{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=ki;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=gi(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
    ...
    `}}m([w({type:Array})],ia.prototype,"forecast",void 0),m([w({type:String})],ia.prototype,"lang",void 0);customElements.define("daily-forecast",ia);class Li extends v{animationManager;forecastService;actionHandler;subscribedEntity=null;subscribedShowDaily=!1;_testTimeOfDay;static get styles(){return Xo}static getConfigElement(){return document.createElement("dynamic-weather-card-editor")}static getStubConfig(){return{type:"custom:dynamic-weather-card",entity:"weather.home",show_hourly_forecast:!0,hourly_forecast_hours:c.hourlyForecastHours,show_daily_forecast:!0,daily_forecast_days:c.dailyForecastDays}}constructor(){super();this.config={},this.animationManager=new Gi(()=>this.getDrawParams()),this.forecastService=new Vi(()=>this.requestUpdate()),this.actionHandler=new Ri(()=>this.hass,()=>this.config,(i,o)=>this.fireEvent(i,o))}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{setTimeout(()=>{let i=this.shadowRoot?.querySelector(".canvas-container");if(i)this.animationManager.setup(i)},100)})}disconnectedCallback(){super.disconnectedCallback(),this.animationManager.destroy(),this.forecastService.unsubscribe()}updated(i){if(super.updated(i),i.has("config")){let a=i.get("config"),n=a?a.showAnimations!==!1:!0,e=this.config.showAnimations!==!1;if(n&&!e)this.animationManager.destroy();else if(!n&&e)this.updateComplete.then(()=>{let r=this.shadowRoot?.querySelector(".canvas-container");if(r)this.animationManager.setup(r)})}if(i.has("hass")||i.has("config")){let a=this.config.entity,n=this.config.showDailyForecast??!1;if(this.hass&&a&&(a!==this.subscribedEntity||n!==this.subscribedShowDaily))this.subscribedEntity=a,this.subscribedShowDaily=n,this.forecastService.subscribe(this.hass,a,n)}let o=E({configLang:this.config?.language,hassLang:this.hass?.language});if(d.lang!==o)d.setLanguage(o)}getDrawParams(){if(!this.hass||!this.config.entity)return null;let i=Ui(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=Ti(o||{},this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||Ci(a);return{condition:i.condition,timeOfDay:n}}getDetailsConfig(){return{showHumidity:this.config.showHumidity??!0,showWind:this.config.showWind??!0,showWindGust:this.config.showWindGust??!0,showWindDirection:this.config.showWindDirection??!0,showSunriseSunset:this.config.showSunriseSunset??!0,clockFormat:this.config.clockFormat??"24h",windSpeedUnit:this.config.windSpeedUnit??"ms"}}setConfig(i){if(!i.entity)throw Error("Please define a weather entity");let o=i.show_hourly_forecast??i.show_forecast;if(this.config={type:"custom:dynamic-weather-card",entity:i.entity,icons_path:i.icons_path,name:i.name,height:i.height||c.height,showFeelsLike:i.show_feels_like!==!1,showWind:i.show_wind!==!1,showWindGust:i.show_wind_gust!==!1,showWindDirection:i.show_wind_direction!==!1,showHumidity:i.show_humidity!==!1,showMinTemp:i.show_min_temp!==!1,showForecast:i.show_forecast===!0,showHourlyForecast:o===!0,showDailyForecast:i.show_daily_forecast===!0,hourlyForecastHours:i.hourly_forecast_hours??c.hourlyForecastHours,dailyForecastDays:i.daily_forecast_days??c.dailyForecastDays,showSunriseSunset:i.show_sunrise_sunset!==!1,showClock:i.show_clock===!0,clockPosition:i.clock_position||c.clockPosition,clockFormat:i.clock_format||c.clockFormat,overlayOpacity:i.overlay_opacity!==void 0?i.overlay_opacity:c.overlayOpacity,textShadow:i.text_shadow!==void 0?i.text_shadow:c.textShadow,language:i.language||c.language,windSpeedUnit:i.wind_speed_unit||c.windSpeedUnit,showAnimations:i.show_animations!==!1,layout:i.layout||c.layout,sunriseEntity:i.sunrise_entity||null,sunsetEntity:i.sunset_entity||null,templowAttribute:i.templow_attribute||null,tapAction:i.tap_action||{action:"more-info"},holdAction:i.hold_action||{action:"none"},doubleTapAction:i.double_tap_action||{action:"none"}},this.config.language)d.setLanguage(this.config.language)}fireEvent(i,o={}){let a=new CustomEvent(i,{detail:o,bubbles:!0,composed:!0});this.dispatchEvent(a)}getCardSize(){return 1}render(){if(!this.hass)return u`<div>No Home Assistant connection</div>`;let i=Ui(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=Ti(o,this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||Ci(a),e=`weather-card ${n.type}`,r=this.config.layout==="minimal",l=r?"56px":"200px",s=this.config.height?`${this.config.height}px`:l,t=Go(n),g=t?`background: linear-gradient(135deg, rgb(${t.start.r}, ${t.start.g}, ${t.start.b}), rgb(${t.end.r}, ${t.end.g}, ${t.end.b}));`:"",y=`--overlay-opacity: ${this.config.overlayOpacity!==void 0?this.config.overlayOpacity:c.overlayOpacity};`,f=this.config.textShadow??c.textShadow,p=f===0?"none":[`0 1px 2px rgba(0,0,0,${Math.min(1,0.4*f).toFixed(2)})`,`0 2px 6px rgba(0,0,0,${Math.min(1,0.3*f).toFixed(2)})`,`0 4px 12px rgba(0,0,0,${Math.min(1,0.2*f).toFixed(2)})`].join(", "),j=f===0?"none":`drop-shadow(0px 1px 3px rgba(0,0,0,${Math.min(1,0.6*f).toFixed(2)}))`,mi=`--card-text-shadow: ${p}; --card-icon-filter: ${j};`,wi=this.config.showHourlyForecast?this.forecastService.getHourlyForecast(this.config.hourlyForecastHours??c.hourlyForecastHours,i):[],la=this.config.showDailyForecast?this.forecastService.getDailyForecast(this.config.dailyForecastDays??c.dailyForecastDays,i):[],Ii=`min-height: ${s}; ${g}; ${y} ${mi} cursor: pointer;`,Ei=this.hass;return u`
      ...
      >
        ${r?this.renderMinimal(i,a,Ei,e,Ii):this.renderDefault(i,a,wi,la,Ei,e,Ii)}
      </ha-card>
    `}renderDefault(i,o,a,n,e,r,l){return u`
      <div class="${r}" style="${l}">
    ...
    `}renderMinimal(i,o,a,n,e){let r=i.temperature!=null?Math.round(i.temperature)+"°":d.t("no_data"),l=i.templow!=null?`↓ ${Math.round(i.templow)}°`:null;return u`
      <div class="${n} layout--minimal" style="${e}">
        ${this.config.showAnimations!==!1?u`<div class="canvas-container"></div>`:""}
        <div class="content">
          <div class="mini-primary">
            <div class="mini-temp">${r}</div>
            ${this.config.showMinTemp&&l?u`<div class="mini-temp-low">${l}</div>`:""}
          </div>
