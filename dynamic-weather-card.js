var m=function(i,o,a,n){var e=arguments.length,l=e<3?o:n===null?n=Object.getOwnPropertyDescriptor(o,a):n,r;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")l=Reflect.decorate(i,o,a,n);else for(var s=i.length-1;s>=0;s--)if(r=i[s])l=(e<3?r(l):e>3?r(o,a,l):r(o,a))||l;return e>3&&l&&Object.defineProperty(o,a,l),l};var ni=globalThis,pi=ni.ShadowRoot&&(ni.ShadyCSS===void 0||ni.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,fi=Symbol(),io=new WeakMap;class zi{constructor(i,o,a){if(this._$cssResult$=!0,a!==fi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=i,this._strings=o}get styleSheet(){let i=this._styleSheet,o=this._strings;if(pi&&i===void 0){let a=o!==void 0&&o.length===1;if(a)i=io.get(o);if(i===void 0){if((this._styleSheet=i=new CSSStyleSheet).replaceSync(this.cssText),a)io.set(o,i)}}return i}toString(){return this.cssText}}var ua=(i)=>{if(i._$cssResult$===!0)return i.cssText;else if(typeof i==="number")return i;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${i}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},da=(i)=>new zi(typeof i==="string"?i:String(i),void 0,fi),Z=(i,...o)=>{let a=i.length===1?i[0]:o.reduce((n,e,l)=>n+ua(e)+i[l+1],i[0]);return new zi(a,i,fi)},oo=(i,o)=>{if(pi)i.adoptedStyleSheets=o.map((a)=>a instanceof CSSStyleSheet?a:a.styleSheet);else for(let a of o){let n=document.createElement("style"),e=ni.litNonce;if(e!==void 0)n.setAttribute("nonce",e);n.textContent=a.cssText,i.appendChild(n)}},ca=(i)=>{let o="";for(let a of i.cssRules)o+=a.cssText;return da(o)},vi=pi?(i)=>i:(i)=>i instanceof CSSStyleSheet?ca(i):i;var{is:ga,defineProperty:_a,getOwnPropertyDescriptor:ao,getOwnPropertyNames:ha,getOwnPropertySymbols:ka,getPrototypeOf:no}=Object,ya=!1,S=globalThis;if(ya)S.customElements??=customElements;var P=!0,A,eo=S.trustedTypes,ma=eo?eo.emptyScript:"",ro=P?S.reactiveElementPolyfillSupportDevMode:S.reactiveElementPolyfillSupport;if(P)S.litIssuedWarnings??=new Set,A=(i,o)=>{if(o+=` See https://lit.dev/msg/${i} for more information.`,!S.litIssuedWarnings.has(o)&&!S.litIssuedWarnings.has(i))console.warn(o),S.litIssuedWarnings.add(o)},queueMicrotask(()=>{if(A("dev-mode","Lit is in dev mode. Not recommended for production!"),S.ShadyDOM?.inUse&&ro===void 0)A("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var wa=P?(i)=>{if(!S.emitLitDebugLogEvents)return;S.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))}:void 0,x=(i,o)=>i,Q={toAttribute(i,o){switch(o){case Boolean:i=i?ma:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i);break}return i},fromAttribute(i,o){let a=i;switch(o){case Boolean:a=i!==null;break;case Number:a=i===null?null:Number(i);break;case Object:case Array:try{a=JSON.parse(i)}catch(n){a=null}break}return a}},ei=(i,o)=>!ga(i,o),lo={attribute:!0,type:String,converter:Q,reflect:!1,useDefault:!1,hasChanged:ei};Symbol.metadata??=Symbol("metadata");S.litPropertyMetadata??=new WeakMap;class M extends HTMLElement{static addInitializer(i){this.__prepare(),(this._initializers??=[]).push(i)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(i,o=lo){if(o.state)o.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(i))o=Object.create(o),o.wrapped=!0;if(this.elementProperties.set(i,o),!o.noAccessor){let a=P?Symbol.for(`${String(i)} (@property() cache)`):Symbol(),n=this.getPropertyDescriptor(i,a,o);if(n!==void 0)_a(this.prototype,i,n)}}static getPropertyDescriptor(i,o,a){let{get:n,set:e}=ao(this.prototype,i)??{get(){return this[o]},set(l){this[o]=l}};if(P&&n==null){if("value"in(ao(this.prototype,i)??{}))throw Error(`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);A("reactive-property-without-getter",`Field ${JSON.stringify(String(i))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:n,set(l){let r=n?.call(this);e?.call(this,l),this.requestUpdate(i,r,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(i){return this.elementProperties.get(i)??lo}static __prepare(){if(this.hasOwnProperty(x("elementProperties",this)))return;let i=no(this);if(i.finalize(),i._initializers!==void 0)this._initializers=[...i._initializers];this.elementProperties=new Map(i.elementProperties)}static finalize(){if(this.hasOwnProperty(x("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(x("properties",this))){let o=this.properties,a=[...ha(o),...ka(o)];for(let n of a)this.createProperty(n,o[n])}let i=this[Symbol.metadata];if(i!==null){let o=litPropertyMetadata.get(i);if(o!==void 0)for(let[a,n]of o)this.elementProperties.set(a,n)}this.__attributeToPropertyMap=new Map;for(let[o,a]of this.elementProperties){let n=this.__attributeNameForProperty(o,a);if(n!==void 0)this.__attributeToPropertyMap.set(n,o)}if(this.elementStyles=this.finalizeStyles(this.styles),P){if(this.hasOwnProperty("createProperty"))A("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))A("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(i){let o=[];if(Array.isArray(i)){let a=new Set(i.flat(1/0).reverse());for(let n of a)o.unshift(vi(n))}else if(i!==void 0)o.push(vi(i));return o}static __attributeNameForProperty(i,o){let a=o.attribute;return a===!1?void 0:typeof a==="string"?a:typeof i==="string"?i.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((i)=>this.enableUpdating=i),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((i)=>i(this))}addController(i){if((this.__controllers??=new Set).add(i),this.renderRoot!==void 0&&this.isConnected)i.hostConnected?.()}removeController(i){this.__controllers?.delete(i)}__saveInstanceProperties(){let i=new Map,o=this.constructor.elementProperties;for(let a of o.keys())if(this.hasOwnProperty(a))i.set(a,this[a]),delete this[a];if(i.size>0)this.__instanceProperties=i}createRenderRoot(){let i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return oo(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((i)=>i.hostConnected?.())}enableUpdating(i){}disconnectedCallback(){this.__controllers?.forEach((i)=>i.hostDisconnected?.())}attributeChangedCallback(i,o,a){this._$attributeToProperty(i,a)}__propertyToAttribute(i,o){let n=this.constructor.elementProperties.get(i),e=this.constructor.__attributeNameForProperty(i,n);if(e!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:Q).toAttribute(o,n.type);if(P&&this.constructor.enabledWarnings.includes("migration")&&r===void 0)A("undefined-attribute-value",`The attribute value for the ${i} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=i,r==null)this.removeAttribute(e);else this.setAttribute(e,r);this.__reflectingProperty=null}}_$attributeToProperty(i,o){let a=this.constructor,n=a.__attributeToPropertyMap.get(i);if(n!==void 0&&this.__reflectingProperty!==n){let e=a.getPropertyOptions(n),l=typeof e.converter==="function"?{fromAttribute:e.converter}:e.converter?.fromAttribute!==void 0?e.converter:Q;this.__reflectingProperty=n;let r=l.fromAttribute(o,e.type);this[n]=r??this.__defaultValues?.get(n)??r,this.__reflectingProperty=null}}requestUpdate(i,o,a,n=!1,e){if(i!==void 0){if(P&&i instanceof Event)A("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let l=this.constructor;if(n===!1)e=this[i];if(a??=l.getPropertyOptions(i),(a.hasChanged??ei)(e,o)||a.useDefault&&a.reflect&&e===this.__defaultValues?.get(i)&&!this.hasAttribute(l.__attributeNameForProperty(i,a)))this._$changeProperty(i,o,a);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(i,o,{useDefault:a,reflect:n,wrapped:e},l){if(a&&!(this.__defaultValues??=new Map).has(i)){if(this.__defaultValues.set(i,l??o??this[i]),e!==!0||l!==void 0)return}if(!this._$changedProperties.has(i)){if(!this.hasUpdated&&!a)o=void 0;this._$changedProperties.set(i,o)}if(n===!0&&this.__reflectingProperty!==i)(this.__reflectingProperties??=new Set).add(i)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(o){Promise.reject(o)}let i=this.scheduleUpdate();if(i!=null)await i;return!this.isUpdatePending}scheduleUpdate(){let i=this.performUpdate();if(P&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof i?.then==="function")A("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return i}performUpdate(){if(!this.isUpdatePending)return;if(wa?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),P){let e=[...this.constructor.elementProperties.keys()].filter((l)=>this.hasOwnProperty(l)&&(l in no(this)));if(e.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${e.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[n,e]of this.__instanceProperties)this[n]=e;this.__instanceProperties=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[n,e]of a){let{wrapped:l}=e,r=this[n];if(l===!0&&!this._$changedProperties.has(n)&&r!==void 0)this._$changeProperty(n,void 0,e,r)}}let i=!1,o=this._$changedProperties;try{if(i=this.shouldUpdate(o),i)this.willUpdate(o),this.__controllers?.forEach((a)=>a.hostUpdate?.()),this.update(o);else this.__markUpdated()}catch(a){throw i=!1,this.__markUpdated(),a}if(i)this._$didUpdate(o)}willUpdate(i){}_$didUpdate(i){if(this.__controllers?.forEach((o)=>o.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(i);if(this.updated(i),P&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))A("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(i){return!0}update(i){this.__reflectingProperties&&=this.__reflectingProperties.forEach((o)=>this.__propertyToAttribute(o,this[o])),this.__markUpdated()}updated(i){}firstUpdated(i){}}M.elementStyles=[];M.shadowRootOptions={mode:"open"};M[x("elementProperties",M)]=new Map;M[x("finalized",M)]=new Map;ro?.({ReactiveElement:M});if(P){M.enabledWarnings=["change-in-update","async-perform-update"];let i=function(o){if(!o.hasOwnProperty(x("enabledWarnings",o)))o.enabledWarnings=o.enabledWarnings.slice()};M.enableWarning=function(o){if(i(this),!this.enabledWarnings.includes(o))this.enabledWarnings.push(o)},M.disableWarning=function(o){i(this);let a=this.enabledWarnings.indexOf(o);if(a>=0)this.enabledWarnings.splice(a,1)}}(S.reactiveElementVersions??=[]).push("2.1.2");if(P&&S.reactiveElementVersions.length>1)queueMicrotask(()=>{A("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var F=globalThis,h=(i)=>{if(!F.emitLitDebugLogEvents)return;F.dispatchEvent(new CustomEvent("lit-debug",{detail:i}))},pa=0,U;F.litIssuedWarnings??=new Set,U=(i,o)=>{if(o+=i?` See https://lit.dev/msg/${i} for more information.`:"",!F.litIssuedWarnings.has(o)&&!F.litIssuedWarnings.has(i))console.warn(o),F.litIssuedWarnings.add(o)},queueMicrotask(()=>{U("dev-mode","Lit is in dev mode. Not recommended for production!")});var H=F.ShadyDOM?.inUse&&F.ShadyDOM?.noPatch===!0?F.ShadyDOM.wrap:(i)=>i,li=F.trustedTypes,so=li?li.createPolicy("lit-html",{createHTML:(i)=>i}):void 0,fa=(i)=>i,ui=(i,o,a)=>fa,za=(i)=>{if(q!==ui)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");q=i},va=()=>{q=ui},Fi=(i,o,a)=>{return q(i,o,a)},ko="$lit$",j=`lit$${Math.random().toFixed(9).slice(2)}$`,yo="?"+j,ba=`<${yo}>`,J=document,L=()=>J.createComment(""),Y=(i)=>i===null||typeof i!="object"&&typeof i!="function",Di=Array.isArray,Sa=(i)=>Di(i)||typeof i?.[Symbol.iterator]==="function",bi=`[ 	
\f\r]`,Pa=`[^ 	
\f\r"'\`<>=]`,Ma=`[^\\s"'>=/]`,V=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,to=1,Si=2,Fa=3,uo=/-->/g,co=/>/g,C=new RegExp(`>|${bi}(?:(${Ma}+)(${bi}*=${bi}*(?:${Pa}|("|')|))|$)`,"g"),Da=0,go=1,Aa=2,_o=3,Pi=/'/g,Mi=/"/g,mo=/^(?:script|style|textarea|title)$/i,Ha=1,ri=2,si=3,Ai=1,ti=2,Na=3,ja=4,Ka=5,Hi=6,Ta=7,Ni=(i)=>(o,...a)=>{if(o.some((n)=>n===void 0))console.warn(`Some template strings are undefined.
...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:i,strings:o,values:a}},c=Ni(Ha),k=Ni(ri),vn=Ni(si),W=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),ho=new WeakMap,B=J.createTreeWalker(J,129),q=ui;function wo(i,o){if(!Di(i)||!i.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`;class b{ctx;constructor(i){this.ctx=i}drawCloud(i,o,a,n){let e=this.ctx.shadowBlur,l=this.ctx.shadowColor,r=this.ctx.globalAlpha;this.ctx.shadowBlur=a*0.25,this.ctx.shadowColor=`rgba(255, 255, 255, ${n*0.4})`,this.ctx.globalAlpha=n*0.85,this.ctx.fillStyle="rgba(255, 255, 255, 1)",[{x:i,y:o,r:a*0.4},{x:i+a*0.35,y:o,r:a*0.5},{x:i+a*0.65,y:o,r:a*0.48},{x:i+a*0.92,y:o,r:a*0.38},{x:i+a*0.18,y:o-a*0.28,r:a*0.38},{x:i+a*0.52,y:o-a*0.32,r:a*0.42},{x:i+a*0.78,y:o-a*0.28,r:a*0.38},{x:i+a*0.32,y:o-a*0.42,r:a*0.32},{x:i+a*0.62,y:o-a*0.48,r:a*0.36},{x:i+a*0.82,y:o-a*0.42,r:a*0.32}].forEach((t)=>{this.ctx.beginPath(),this.ctx.arc(t.x,t.y,t.r,0,Math.PI*2),this.ctx.fill()}),this.ctx.shadowBlur=e,this.ctx.shadowColor=l,this.ctx.globalAlpha=r}drawClouds(i,o,a,n=0.5){let e=Math.max(2,Math.floor(o/150*n));for(let l=0;l<e;l++){let r=(i*3+l*150)%(o+200)-100,s=a*(0.2+l%3*0.15)+Math.sin(i*0.2+l)*8,t=40+l%3*15,g=0.6+l%2*0.2;this.drawCloud(r,s,t,g)}}}class Ji extends b{draw(i,o,a,n){let e=Date.now()*0.001,l=Vo(n,o,a),r=l.x,s=l.y;if(n.type==="day"||n.type==="sunrise"||n.type==="sunset"){if(this.drawSun(r,s,e),n.type==="sunrise"||n.type==="sunset")this.drawHorizonReflection(r,s,a,e)}else if(n.type==="night")this.drawNightSky(o,a,e);this.drawClouds(e,o,a,0.3)}drawSun(i,o,a){let n=48+Math.sin(a*0.15)*1.5,e=this.ctx.createRadialGradient(i,o,n*0.3,i,o,n*3.5);e.addColorStop(0,"rgba(255, 248, 230, 0.25)"),e.addColorStop(0.15,"rgba(255, 240, 200, 0.2)"),e.addColorStop(0.3,"rgba(255, 230, 170, 0.15)"),e.addColorStop(0.5,"rgba(255, 220, 140, 0.1)"),e.addColorStop(0.7,"rgba(255, 210, 120, 0.06)"),e.addColorStop(0.85,"rgba(255, 200, 100, 0.03)"),e.addColorStop(1,"rgba(255, 190, 90, 0)"),this.ctx.fillStyle=e,this.ctx.beginPath(),this.ctx.arc(i,o,n*3.5,0,Math.PI*2),this.ctx.fill();let l=this.ctx.createRadialGradient(i,o,n*0.5,i,o,n*2.2);l.addColorStop(0,"rgba(255, 250, 220, 0.35)"),l.addColorStop(0.3,"rgba(255, 240, 190, 0.25)"),l.addColorStop(0.6,"rgba(255, 230, 160, 0.15)"),l.addColorStop(0.85,"rgba(255, 220, 140, 0.08)"),l.addColorStop(1,"rgba(255, 210, 120, 0)"),this.ctx.fillStyle=l,this.ctx.beginPath(),this.ctx.arc(i,o,n*2.2,0,Math.PI*2),this.ctx.fill();let r=this.ctx.createRadialGradient(i,o,n*0.6,i,o,n*1.6);r.addColorStop(0,"rgba(255, 252, 240, 0.5)"),r.addColorStop(0.4,"rgba(255, 245, 210, 0.35)"),r.addColorStop(0.7,"rgba(255, 235, 180, 0.2)"),r.addColorStop(1,"rgba(255, 225, 150, 0)"),this.ctx.fillStyle=r,this.ctx.beginPath(),this.ctx.arc(i,o,n*1.6,0,Math.PI*2),this.ctx.fill();let s=this.ctx.createRadialGradient(i-n*0.1,o-n*0.1,0,i,o,n);s.addColorStop(0,"#FFFEF5"),s.addColorStop(0.15,"#FFF9E6"),s.addColorStop(0.3,"#FFF4D6"),s.addColorStop(0.5,"#FFEDC0"),s.addColorStop(0.7,"#FFE4A8"),s.addColorStop(0.85,"#FFDC95"),s.addColorStop(1,"#FFD37F"),this.ctx.fillStyle=s,this.ctx.beginPath(),this.ctx.arc(i,o,n,0,Math.PI*2),this.ctx.fill()}drawHorizonReflection(i,o,a,n){let e=48+Math.sin(n*0.15)*1.5,l=a*0.85;if(o>=l-50){let r=Math.max(0,(l-o)/50)*0.3;this.ctx.fillStyle=`rgba(255, 140, 0, ${r})`,this.ctx.beginPath(),this.ctx.ellipse(i,l,e*1.5,e*0.5,0,0,Math.PI*2),this.ctx.fill()}}drawNightSky(i,o,a){this.ctx.fillStyle="#FFFFFF";for(let l=0;l<20;l++){let r=(i*0.2+l*47)%i,s=(o*0.2+l*23)%(o*0.6),t=Math.sin(a*0.8+l)*0.5+0.5;this.ctx.globalAlpha=t*0.8,this.ctx.beginPath(),this.ctx.arc(r,s,1.5,0,Math.PI*2),this.ctx.fill()}let n=i*0.75,e=o*0.3;this.ctx.globalAlpha=0.9,this.ctx.fillStyle="#F0F0F0",this.ctx.beginPath(),this.ctx.arc(n,e,25,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="#1a1a2e",this.ctx.beginPath(),this.ctx.arc(n-8,e-5,22,0,Math.PI*2),this.ctx.fill(),this.ctx.globalAlpha=1}}class ii extends b{rainDrops=[];lastTime=0;draw(i,o,a,n,e=!1){let l=Date.now()*0.001;this.drawClouds(l,o,a,e?1:0.8),this.drawRain(o,a,e)}drawRain(i,o,a){let n=a?130:90;if(this.rainDrops.length!==n){this.rainDrops=[];for(let s=0;s<n;s++)this.rainDrops.push({x:Math.random()*i,y:Math.random()*o-Math.random()*200,speed:a?80+Math.random()*100:60+Math.random()*80,windOffset:(Math.random()-0.5)*30,width:a?1.2+Math.random()*1:0.8+Math.random()*0.7,length:a?8+Math.random()*10:6+Math.random()*8,alpha:a?0.75+Math.random()*0.15:0.65+Math.random()*0.2,phase:Math.random()*Math.PI*2})}let e=Date.now()*0.001,l=this.lastTime>0?Math.min(e-this.lastTime,0.1):0.016666666666666666;this.lastTime=e;let r=e;for(let s=0;s<this.rainDrops.length;s++){let t=this.rainDrops[s];if(t.y+=t.speed*l,t.y>o+50)t.y=-50-Math.random()*100,t.x=Math.random()*i;let g=t.windOffset*(1+Math.sin(r*0.5+t.phase)*0.2),_=t.x+g;if(_<-10)t.x=i+10;else if(_>i+10)t.x=-10;this.drawRainDrop(_,t.y,t)}}drawRainDrop(i,o,a){this.ctx.save(),this.ctx.globalAlpha=a.alpha;let n=o-a.length*0.5,e=o+a.length*0.5,l=a.alpha,r=a.alpha*0.5;this.ctx.fillStyle="rgba(220, 240, 255, "+l+")",this.ctx.strokeStyle="rgba(240, 250, 255, "+r+")",this.ctx.lineWidth=0.4,this.ctx.beginPath(),this.ctx.moveTo(i,n),this.ctx.quadraticCurveTo(i-a.width*0.3,o,i-a.width,e-a.width*0.3),this.ctx.arc(i,e,a.width,Math.PI,0,!1),this.ctx.quadraticCurveTo(i+a.width*0.3,o,i,n),this.ctx.closePath(),this.ctx.fill(),this.ctx.stroke(),this.ctx.restore()}}class Wi extends b{snowflakes=[];lastTime=0;draw(i,o,a,n){let e=Date.now()*0.001;this.drawClouds(e,o,a,0.7),this.drawSnowflakes(o,a)}drawSnowflakes(i,o){let a=Math.floor(i*o/5000),n=Math.max(30,Math.min(a,80));if(this.snowflakes.length!==n){this.snowflakes=[];for(let s=0;s<n;s++)this.snowflakes.push({x:Math.random()*i,y:Math.random()*o-Math.random()*100,speedY:15+Math.random()*10,speedX:(Math.random()-0.5)*8,size:1.5+Math.random()*1.5,alpha:0.6+Math.random()*0.3,rotation:Math.random()*Math.PI*2,rotationSpeed:(Math.random()-0.5)*0.3,swayPhase:Math.random()*Math.PI*2,swaySpeed:0.5+Math.random()*0.5})}let e=Date.now()*0.001,l=this.lastTime>0?Math.min(e-this.lastTime,0.1):0.016666666666666666;this.lastTime=e;let r=e;this.ctx.lineCap="round";for(let s=0;s<this.snowflakes.length;s++){let t=this.snowflakes[s],g=Math.sin(r*t.swaySpeed+t.swayPhase)*2;if(t.y+=t.speedY*l,t.x+=(t.speedX+g)*l,t.rotation+=t.rotationSpeed*l,t.y>o+20)t.y=-20-Math.random()*50,t.x=Math.random()*i;if(t.x<-10)t.x=i+10;else if(t.x>i+10)t.x=-10;this.drawSnowflake(t.x,t.y,t.size,t.alpha,t.rotation)}}drawSnowflake(i,o,a,n,e){this.ctx.save(),this.ctx.translate(i,o),this.ctx.rotate(e),this.ctx.strokeStyle=`rgba(255, 255, 255, ${n})`,this.ctx.lineWidth=1,this.ctx.beginPath();for(let l=0;l<6;l++){let r=Math.PI/3*l,s=Math.cos(r),t=Math.sin(r);this.ctx.moveTo(0,0),this.ctx.lineTo(t*a*2.5,s*a*2.5);let g=t*a*1.5+s*a*0.5,_=s*a*1.5-t*a*0.5,y=t*a*1.8+s*a*1.2,p=s*a*1.8-t*a*1.2;this.ctx.moveTo(g,_),this.ctx.lineTo(y,p);let f=t*a*1.5-s*a*0.5,D=s*a*1.5+t*a*0.5,mi=t*a*1.8-s*a*1.2,wi=s*a*1.8+t*a*1.2;this.ctx.moveTo(f,D),this.ctx.lineTo(mi,wi)}this.ctx.stroke(),this.ctx.restore()}}class qi extends b{draw(i,o,a,n){let e=Date.now()*0.001;this.drawClouds(e,o,a,0.7)}}class xi extends b{draw(i,o,a,n){let e=Date.now()*0.0003;this.ctx.fillStyle="rgba(200, 200, 200, 0.4)";for(let l=0;l<3;l++){let r=a*(0.4+l*0.2),s=Math.sin(e+l)*20;this.ctx.beginPath(),this.ctx.moveTo(0,r);for(let t=0;t<=o;t+=5){let g=Math.sin((t/o+e)*Math.PI*4+l)*15;this.ctx.lineTo(t,r+g+s)}this.ctx.lineTo(o,a),this.ctx.lineTo(0,a),this.ctx.closePath(),this.ctx.fill()}}}class Gi extends b{hailStones=[];draw(i,o,a,n){let e=Date.now()*0.001;this.drawClouds(e,o,a,1),this.drawHailStones(o,a)}drawHailStones(i,o){if(this.hailStones.length!==60){this.hailStones=[];for(let e=0;e<60;e++)this.hailStones.push({startX:Math.random()*i,startY:Math.random()*(o+150)-75,speed:120+Math.random()*80,windOffset:(Math.random()-0.5)*20,size:2+Math.random()*3,alpha:0.8+Math.random()*0.15,phase:Math.random()*Math.PI*2})}let n=Date.now()*0.002;this.ctx.fillStyle="rgba(240, 250, 255, 1)",this.ctx.strokeStyle="rgba(255, 255, 255, 0.9)",this.ctx.lineWidth=0.5;for(let e=0;e<this.hailStones.length;e++){let l=this.hailStones[e],r=(l.startY+n*l.speed)%(o+150);if(r>o+30)l.startY=-30-Math.random()*30,l.startX=Math.random()*i;let s=l.windOffset*(1+Math.sin(n*0.6+l.phase)*0.15),t=(l.startX+s+n*20%i)%i;if(t<-5)l.startX=i+5;else if(t>i+5)l.startX=-5;this.drawHailStone(t,r,l)}}drawHailStone(i,o,a){this.ctx.save(),this.ctx.globalAlpha=a.alpha,this.ctx.beginPath(),this.ctx.ellipse(i,o,a.size,a.size*0.9,0,0,Math.PI*2),this.ctx.fill(),this.ctx.stroke(),this.ctx.fillStyle="rgba(255, 255, 255, 0.6)",this.ctx.beginPath(),this.ctx.ellipse(i-a.size*0.3,o-a.size*0.3,a.size*0.3,a.size*0.25,0,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="rgba(240, 250, 255, 1)",this.ctx.restore()}}class $i extends b{rainyAnimation;constructor(i){super(i);this.rainyAnimation=new ii(i)}draw(i,o,a,n,e=!0){let l=Date.now()*0.001;if(this.drawClouds(l,o,a,1),e)this.rainyAnimation.draw(i,o,a,n,!1);this.drawLightning(o,a,l)}drawLightning(i,o,a){let n=Math.sin(a*2.5)*Math.sin(a*5.3)*Math.sin(a*7.1),e=Math.max(0,n);if(e>0.4){let l=(e-0.4)/0.6,r=l*0.6,s=Math.min(r,Math.sin(l*Math.PI)*0.6);this.ctx.fillStyle=`rgba(255, 255, 255, ${s})`,this.ctx.fillRect(0,0,i,o)}}}class Qi{canvas=null;ctx=null;animationFrame=null;animations={};resizeObserver=null;width=0;height=0;container=null;getDrawParams;handleVisibilityChange=()=>{if(document.hidden)this.stopAnimation();else this.startAnimation()};constructor(i){this.getDrawParams=i}setup(i){if(this.container=i,this.setupCanvas(),this.canvas&&this.ctx)this.initializeAnimations(),this.startAnimation(),this.setupResizeObserver(),document.addEventListener("visibilitychange",this.handleVisibilityChange)}destroy(){if(document.removeEventListener("visibilitychange",this.handleVisibilityChange),this.stopAnimation(),this.resizeObserver)this.resizeObserver.disconnect(),this.resizeObserver=null;this.canvas=null,this.ctx=null,this.container=null}resize(){if(this.canvas&&this.ctx)this.resizeCanvas()}setupCanvas(){if(!this.container)return;let i=this.container.querySelector("canvas");if(i)i.remove();this.canvas=document.createElement("canvas"),this.container.appendChild(this.canvas),this.resizeCanvas()}resizeCanvas(){if(!this.canvas||!this.container)return;let i=this.container.getBoundingClientRect();if(i.width===0||i.height===0)return;let o=window.devicePixelRatio||2;if(this.canvas.width=i.width*o,this.canvas.height=i.height*o,this.canvas.style.width="100%",this.canvas.style.height="100%",this.ctx=this.canvas.getContext("2d"),this.ctx)this.ctx.scale(o,o);this.width=i.width,this.height=i.height,this.initializeAnimations()}setupResizeObserver(){if(!this.container)return;this.resizeObserver=new ResizeObserver(()=>{this.resizeCanvas()}),this.resizeObserver.observe(this.container)}initializeAnimations(){if(!this.ctx)return;this.animations={sunny:new Ji(this.ctx),rainy:new ii(this.ctx),snowy:new Wi(this.ctx),cloudy:new qi(this.ctx),foggy:new xi(this.ctx),hail:new Gi(this.ctx),thunderstorm:new $i(this.ctx)}}startAnimation(){if(this.animationFrame)return;let i=()=>{this.draw(),this.animationFrame=requestAnimationFrame(i)};i()}stopAnimation(){if(this.animationFrame)cancelAnimationFrame(this.animationFrame),this.animationFrame=null}draw(){if(!this.ctx||!this.canvas)return;if(!this.width||!this.height){if(this.resizeCanvas(),!this.width||!this.height)return}let i=this.getDrawParams();if(!i)return;let{condition:o,timeOfDay:a}=i,n=this.width,e=this.height;switch(this.ctx.clearRect(0,0,n,e),o.toLowerCase()){case"sunny":case"clear":this.animations.sunny?.draw(Date.now(),n,e,a);break;case"clear-night":this.animations.sunny?.draw(Date.now(),n,e,{type:"night",progress:0});break;case"rainy":case"rain":this.animations.rainy?.draw(Date.now(),n,e,a,!1);break;case"pouring":this.animations.rainy?.draw(Date.now(),n,e,a,!0);break;case"snowy":case"snow":this.animations.snowy?.draw(Date.now(),n,e,a);break;case"snowy-rainy":this.animations.rainy?.draw(Date.now(),n,e,a,!1),this.animations.snowy?.draw(Date.now(),n,e,a);break;case"hail":this.animations.hail?.draw(Date.now(),n,e,a);break;case"foggy":case"fog":this.animations.foggy?.draw(Date.now(),n,e,a);break;case"lightning":this.animations.thunderstorm?.draw(Date.now(),n,e,a,!1);break;case"lightning-rainy":this.animations.thunderstorm?.draw(Date.now(),n,e,a,!0);break;case"cloudy":case"partlycloudy":default:this.animations.cloudy?.draw(Date.now(),n,e,a);break}}}class Vi{hourlyForecast=[];dailyForecast=[];hourlySubscription=null;dailySubscription=null;onUpdate;constructor(i){this.onUpdate=i}getHourlyData(){return this.hourlyForecast}getDailyData(){return this.dailyForecast}async subscribe(i,o,a){if(!i||!o)return;await this.unsubscribe();try{if(this.hourlySubscription=i.connection.subscribeMessage((n)=>{if(n.forecast&&n.forecast.length>0)this.hourlyForecast=n.forecast,this.onUpdate()},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:o}),a)this.dailySubscription=i.connection.subscribeMessage((n)=>{if(n.forecast&&n.forecast.length>0)this.dailyForecast=n.forecast,this.onUpdate()},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:o})}catch{}}async unsubscribe(){if(this.hourlySubscription){try{(await this.hourlySubscription)()}catch{}this.hourlySubscription=null}if(this.dailySubscription){try{(await this.dailySubscription)()}catch{}this.dailySubscription=null}}getHourlyForecast(i,o){let a=Math.max(1,Math.floor(Number(i??d.hourlyForecastHours)));if(this.hourlyForecast&&this.hourlyForecast.length>0)return this.hourlyForecast.slice(0,a);if(!o?.forecast||o.forecast.length===0)return[];let n=new Date,e=new Date(n.getFullYear(),n.getMonth(),n.getDate()),l=new Date(e);return l.setDate(l.getDate()+1),o.forecast.filter((s)=>{if(!s.datetime)return!1;let t=new Date(s.datetime),g=new Date(t.getFullYear(),t.getMonth(),t.getDate());return g.getTime()===e.getTime()||g.getTime()===l.getTime()&&t.getHours()<=n.getHours()}).sort((s,t)=>new Date(s.datetime).getTime()-new Date(t.datetime).getTime()).slice(0,a)}getDailyForecast(i,o){let a=Math.max(1,Math.floor(Number(i??d.dailyForecastDays)));if(this.dailyForecast&&this.dailyForecast.length>0)return this.dailyForecast.slice(0,a);if(!o?.forecast||o.forecast.length===0)return[];let n=new Date,e=new Date(n.getFullYear(),n.getMonth(),n.getDate()),l=new Date(e);l.setDate(l.getDate()+a);let r=(t)=>{let g=t.getFullYear(),_=String(t.getMonth()+1).padStart(2,"0"),y=String(t.getDate()).padStart(2,"0");return`${g}-${_}-${y}`},s=new Map;return o.forecast.forEach((t)=>{if(!t.datetime)return;let g=new Date(t.datetime);if(Number.isNaN(g.getTime()))return;if(g<e||g>=l)return;let _=r(g),y=Math.abs(g.getHours()+g.getMinutes()/60-12),p=s.get(_);if(!p||y<p.hourScore)s.set(_,{item:t,itemDate:g,hourScore:y})}),Array.from(s.values()).sort((t,g)=>t.itemDate.getTime()-g.itemDate.getTime()).map((t)=>t.item).slice(0,a)}}class Ri{holdTimer=null;lastTap=null;holdFired=!1;holdDelay=500;getHass;getConfig;fireEvent;constructor(i,o,a){this.getHass=i,this.getConfig=o,this.fireEvent=a}handleTap(i){if(i.target.closest(".forecast-item")||i.target.closest(".info-item"))return;if(this.lastTap&&Date.now()-this.lastTap<300){this.handleDoubleTap(),this.lastTap=null;return}this.lastTap=Date.now(),setTimeout(()=>{if(this.lastTap)this.handleAction(this.getConfig().tapAction),this.lastTap=null},300)}handlePointerDown(){this.holdTimer=window.setTimeout(()=>{this.handleHold(),this.holdFired=!0},this.holdDelay)}handlePointerUp(i){if(this.holdTimer)clearTimeout(this.holdTimer);if(this.holdFired)i.preventDefault(),i.stopPropagation(),this.holdFired=!1}handleHold(){this.handleAction(this.getConfig().holdAction)}handleDoubleTap(){this.handleAction(this.getConfig().doubleTapAction)}handleAction(i){let o=this.getHass(),a=this.getConfig();if(!i||!o)return;switch(i.action||"more-info"){case"more-info":this.fireEvent("hass-more-info",{entityId:i.entity||a.entity});break;case"toggle":o.callService("homeassistant","toggle",{entity_id:i.entity||a.entity});break;case"call-service":if(i.service){let[e,l]=i.service.split(".");o.callService(e,l,i.service_data||{})}break;case"navigate":if(i.navigation_path)window.history.pushState(null,"",i.navigation_path),this.fireEvent("location-changed",{replace:!1});break;case"url":if(i.url_path)window.open(i.url_path);break;case"none":default:break}}}function sn(i,o){if(!i||!o)return null;let a=i.states[o];return a?a.state:null}function _i(i,o){if(!i||!o)return{};let a=i.states[o];return a?a.attributes:{}}function Ui(i,o,a,n){let e=sn(i,o),l=_i(i,o),r=l.condition||e||"sunny",s=null;if(a.templowAttribute&&l[a.templowAttribute]!=null)s=l[a.templowAttribute];else{for(let t of Do)if(l[t]!=null){s=l[t];break}if(s==null)s=(l.forecast&&l.forecast[0]?l.forecast[0].templow??null:null)||(l.forecast_hourly&&l.forecast_hourly[0]?l.forecast_hourly[0].native_templow??null:null)}return{condition:r,temperature:l.temperature!=null?l.temperature:null,apparentTemperature:l.apparent_temperature||null,humidity:l.humidity!=null?l.humidity:null,windSpeed:l.wind_speed!=null?l.wind_speed:null,windGust:l.wind_gust_speed||l.wind_gust||null,windBearing:l.wind_bearing!=null?l.wind_bearing:null,windDirection:l.wind_direction||null,pressure:l.pressure||null,forecast:l.forecast||l.forecast_hourly||n||[],friendlyName:l.friendly_name||u.t("weather"),templow:s}}class Io extends v{constructor(){super(...arguments);this.format=null;this.compact=!1;this.currentTime=""}clockInterval=null;static styles=Z`
  ...
  `;connectedCallback(){if(super.connectedCallback(),this.format)this.updateTime(),this.clockInterval=window.setInterval(()=>this.updateTime(),1000)}disconnectedCallback(){if(super.disconnectedCallback(),this.clockInterval)clearInterval(this.clockInterval),this.clockInterval=null}updated(i){if(super.updated(i),i.has("format")){if(this.clockInterval)clearInterval(this.clockInterval),this.clockInterval=null;if(this.format)this.updateTime(),this.clockInterval=window.setInterval(()=>this.updateTime(),1000)}}updateTime(){if(!this.format)return;this.currentTime=Oo(new Date,this.format,u.t("am"),u.t("pm"))}render(){if(!this.format)return c``;return c`<div class="clock">${this.currentTime}</div>`}}m([w({type:String})],Io.prototype,"format",void 0),m([w({type:Boolean,reflect:!0})],Io.prototype,"compact",void 0),m([di()],Io.prototype,"currentTime",void 0);customElements.define("weather-clock",Io);var tn={wind:k`
...
`,un={sunny:k`
  ...
  `};function oi(i,...o){let a=tn[i];if(typeof a==="function")return a(...o);return a||""}function hi(i){if(!i)return"";return un[i.toLowerCase()]||""}class ia extends v{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null;this.compact=!1}static styles=Z`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return c``;return c`
      <div class="info-item">
        <span class="info-icon">${oi("humidity")}</span>
        <span>${this.weather.humidity} %</span>
      </div>
    `}renderSunrise(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunrise)return c``;return c`
      <div class="info-item">
        <span class="info-icon">${oi("sunrise")}</span>
        <span>${Ti(this.sunData.sunrise,this.config.clockFormat,u.t("am"),u.t("pm"))}</span>
      </div>
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return c``;let i=this.entityAttributes||{},o=Bi(this.weather.windSpeed,i,this.config.windSpeedUnit),a=Yo(i,this.config.windSpeedUnit,u.t.bind(u)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Bi(this.weather.windGust,i,this.config.windSpeedUnit)} ${a}`;let e=this.config.showWindDirection&&this.weather.windBearing!=null?Eo(this.weather.windBearing):oi("wind");return c`
      <div class="info-item">
        <span class="info-icon">${e}</span>
        <span>${o} ${a}${n}</span>
      </div>
    `}renderSunset(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunset)return c``;return c`
      <div class="info-item">
        <span class="info-icon">${oi("sunset")}</span>
        <span>${Ti(this.sunData.sunset,this.config.clockFormat,u.t("am"),u.t("pm"))}</span>
      </div>
    `}render(){if(!this.hasContent())return c``;let o=this.config?.showSunriseSunset&&this.sunData?.hasSunData?c`
      <div class="sun-group">
        ${this.renderSunrise()}
        ${this.renderSunset()}
      </div>
    `:c``;return c`
      <div class="info-grid">
        ${this.renderHumidity()}
        ${this.renderWind()}
        ${this.compact?o:c`${this.renderSunrise()}${this.renderSunset()}`}
      </div>
    `}}m([w({type:Object})],ia.prototype,"weather",void 0),m([w({type:Object})],ia.prototype,"sunData",void 0),m([w({type:Object})],ia.prototype,"config",void 0),m([w({type:Object})],ia.prototype,"entityAttributes",void 0),m([w({type:Boolean,reflect:!0})],ia.prototype,"compact",void 0);customElements.define("weather-details",ia);var ki=Z`
  :host {
    display: block;
  }
...
`;class oa extends v{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=ki;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=gi(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return c``;return c`
      <div class="forecast-container">
        <div class="forecast-title">${u.t("forecast_title")}</div>
        <div class="forecast-scroll">
          ${this.forecast.map((i)=>c`
            <div class="forecast-item">
              <div class="forecast-time">${Uo(i.datetime,this.clockFormat,u.t("am"),u.t("pm"))}</div>
    ...
    `}}m([w({type:Array})],oa.prototype,"forecast",void 0),m([w({type:String})],oa.prototype,"clockFormat",void 0);customElements.define("hourly-forecast",oa);class aa extends v{constructor(){super(...arguments);this.forecast=[];this.lang="en"}static styles=ki;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=gi(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(i){return Math.round(i.temperature??i.temp??i.native_temperature??0)}render(){if(this.forecast.length===0)return c``;return c`
      <div class="forecast-container">
        <div class="forecast-title">${u.t("daily_forecast_title")}</div>
        <div class="forecast-scroll">
          ${this.forecast.map((i)=>c`
            <div class="forecast-item">
              <div class="forecast-time">${Lo(i.datetime,this.lang)}</div>
              <div class="forecast-icon">${hi(i.condition||"sunny")}</div>
              <div class="forecast-temp">${this.getTemperature(i)}°</div>
            </div>
          `)}
    ...
    `}}m([w({type:Array})],aa.prototype,"forecast",void 0),m([w({type:String})],aa.prototype,"lang",void 0);customElements.define("daily-forecast",aa);class Li extends v{animationManager;forecastService;actionHandler;subscribedEntity=null;subscribedShowDaily=!1;_testTimeOfDay;static get styles(){return Xo}static getConfigElement(){return document.createElement("dynamic-weather-card-editor")}static getStubConfig(){return{type:"custom:dynamic-weather-card",entity:"weather.home",show_hourly_forecast:!0,hourly_forecast_hours:d.hourlyForecastHours,show_daily_forecast:!0,daily_forecast_days:d.dailyForecastDays}}constructor(){super();this.config={},this.animationManager=new Qi(()=>this.getDrawParams()),this.forecastService=new Vi(()=>this.requestUpdate()),this.actionHandler=new Ri(()=>this.hass,()=>this.config,(i,o)=>this.fireEvent(i,o))}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{setTimeout(()=>{let i=this.shadowRoot?.querySelector(".canvas-container");if(i)this.animationManager.setup(i)},100)})}disconnectedCallback(){super.disconnectedCallback(),this.animationManager.destroy(),this.forecastService.unsubscribe()}updated(i){if(super.updated(i),i.has("config")){let a=i.get("config"),n=a?a.showAnimations!==!1:!0,e=this.config.showAnimations!==!1;if(n&&!e)this.animationManager.destroy();else if(!n&&e)this.updateComplete.then(()=>{let l=this.shadowRoot?.querySelector(".canvas-container");if(l)this.animationManager.setup(l)})}if(i.has("hass")||i.has("config")){let a=this.config.entity,n=this.config.showDailyForecast??!1;if(this.hass&&a&&(a!==this.subscribedEntity||n!==this.subscribedShowDaily))this.subscribedEntity=a,this.subscribedShowDaily=n,this.forecastService.subscribe(this.hass,a,n)}let o=E({configLang:this.config?.language,hassLang:this.hass?.language});if(u.lang!==o)u.setLanguage(o)}getDrawParams(){if(!this.hass||!this.config.entity)return null;let i=Ui(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=Zi(o||{},this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||Ci(a);return{condition:i.condition,timeOfDay:n}}getDetailsConfig(){return{showHumidity:this.config.showHumidity??!0,showWind:this.config.showWind??!0,showWindGust:this.config.showWindGust??!0,showWindDirection:this.config.showWindDirection??!0,showSunriseSunset:this.config.showSunriseSunset??!0,clockFormat:this.config.clockFormat??"24h",windSpeedUnit:this.config.windSpeedUnit??"ms"}}setConfig(i){if(!i.entity)throw Error("Please define a weather entity");let o=i.show_hourly_forecast??i.show_forecast;if(this.config={type:"custom:dynamic-weather-card",entity:i.entity,icons_path:i.icons_path,name:i.name,height:i.height||d.height,showFeelsLike:i.show_feels_like!==!1,showWind:i.show_wind!==!1,showWindGust:i.show_wind_gust!==!1,showWindDirection:i.show_wind_direction!==!1,showHumidity:i.show_humidity!==!1,showMinTemp:i.show_min_temp!==!1,showForecast:i.show_forecast===!0,showHourlyForecast:o===!0,showDailyForecast:i.show_daily_forecast===!0,hourlyForecastHours:i.hourly_forecast_hours??d.hourlyForecastHours,dailyForecastDays:i.daily_forecast_days??d.dailyForecastDays,showSunriseSunset:i.show_sunrise_sunset!==!1,showClock:i.show_clock===!0,clockPosition:i.clock_position||d.clockPosition,clockFormat:i.clock_format||d.clockFormat,overlayOpacity:i.overlay_opacity!==void 0?i.overlay_opacity:d.overlayOpacity,textShadow:i.text_shadow!==void 0?i.text_shadow:d.textShadow,language:i.language||d.language,windSpeedUnit:i.wind_speed_unit||d.windSpeedUnit,showAnimations:i.show_animations!==!1,layout:i.layout||d.layout,sunriseEntity:i.sunrise_entity||null,sunsetEntity:i.sunset_entity||null,templowAttribute:i.templow_attribute||null,tapAction:i.tap_action||{action:"more-info"},holdAction:i.hold_action||{action:"none"},doubleTapAction:i.double_tap_action||{action:"none"}},this.config.language)u.setLanguage(this.config.language)}fireEvent(i,o={}){let a=new CustomEvent(i,{detail:o,bubbles:!0,composed:!0});this.dispatchEvent(a)}getCardSize(){return 1}render(){if(!this.hass)return c`<div>No Home Assistant connection</div>`;let i=Ui(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),o=this.hass.states[this.config.entity],a=Zi(o,this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||Ci(a),e=`weather-card ${n.type}`,l=this.config.layout==="minimal",r=l?"56px":"200px",s=this.config.height?`${this.config.height}px`:r,t=Ro(n),g=t?`background: linear-gradient(135deg, rgb(${t.start.r}, ${t.start.g}, ${t.start.b}), rgb(${t.end.r}, ${t.end.g}, ${t.end.b}));`:"",y=`--overlay-opacity: ${this.config.overlayOpacity!==void 0?this.config.overlayOpacity:d.overlayOpacity};`,p=this.config.textShadow??d.textShadow,f=p===0?"none":[`0 1px 2px rgba(0,0,0,${Math.min(1,0.4*p).toFixed(2)})`,`0 2px 6px rgba(0,0,0,${Math.min(1,0.3*p).toFixed(2)})`,`0 4px 12px rgba(0,0,0,${Math.min(1,0.2*p).toFixed(2)})`].join(", "),D=p===0?"none":`drop-shadow(0px 1px 3px rgba(0,0,0,${Math.min(1,0.6*p).toFixed(2)}))`,mi=`--card-text-shadow: ${f}; --card-icon-filter: ${D};`,wi=this.config.showHourlyForecast?this.forecastService.getHourlyForecast(this.config.hourlyForecastHours??d.hourlyForecastHours,i):[],ta=this.config.showDailyForecast?this.forecastService.getDailyForecast(this.config.dailyForecastDays??d.dailyForecastDays,i):[],Ii=`min-height: ${s}; ${g}; ${y} ${mi} cursor: pointer;`,Ei=this.hass;return c`
      <ha-card
      ...
      >
        ${l?this.renderMinimal(i,a,Ei,e,Ii):this.renderDefault(i,a,wi,ta,Ei,e,Ii)}
      </ha-card>
    `}renderDefault(i,o,a,n,e,l,r){return c`
      <div class="${l}" style="${r}">
        ${this.config.showAnimations!==!1?c`<div class="canvas-container"></div>`:""}
        <div class="content">
          ${this.config.name&&this.config.name.trim()!==""?c`
            <div class="header">
          ...
          <div class="primary">
            <div class="primary-left">
              <div class="condition">${u.t(i.condition)}</div>
              <div class="temperature">${i.temperature!=null?Math.round(i.temperature)+"°":u.t("no_data")}</div>
              ${this.config.showMinTemp?c`
                <div class="temp-range">
                  <span class="temp-min">↓ ${i.templow!=null?`${Math.round(i.templow)}°`:u.t("no_data")}</span>
                </div>
              `:""}
              ${this.config.showFeelsLike?c`
                <div class="feels-like">${u.t("feels_like")} ${i.apparentTemperature!=null?`${Math.round(i.apparentTemperature)}°`:u.t("no_data")}</div>
              `:""}
            </div>
            <weather-clock
    ...
    `}renderMinimal(i,o,a,n,e){let l=i.temperature!=null?Math.round(i.temperature)+"°":u.t("no_data"),r=i.templow!=null?`↓ ${Math.round(i.templow)}°`:null;return c`
      <div class="${n} layout--minimal" style="${e}">
        ${this.config.showAnimations!==!1?c`<div class="canvas-container"></div>`:""}
        <div class="content">
          <div class="mini-primary">
            <div class="mini-temp">${l}</div>
            ${this.config.showMinTemp&&r?c`<div class="mini-temp-low">${r}</div>`:""}
          </div>
          <div class="mini-details">
            <div class="mini-condition">${u.t(i.condition)}</div>
            <weather-details
              .weather=${i}
              .sunData=${o}
              .config=${this.getDetailsConfig()}
          ...
          ${this.config.showClock?c`
            <weather-clock .format=${this.config.clockFormat} .compact=${!0}></weather-clock>
          `:""}
        </div>
      </div>
    `}}m([w({type:Object})],Li.prototype,"hass",void 0),m([w({type:Object})],Li.prototype,"config",void 0);var dn=(i)=>{let o=`editor.language_${i}`,a=u.t(o);if(a!==o)return a;try{return new Intl.DisplayNames([u.lang],{type:"language"}).of(i)??i}catch{return i}};class Yi extends v{constructor(){super(...arguments);this._config={}}setConfig(i){this._config={name:"",layout:d.layout,height:d.height,show_feels_like:d.showFeelsLike,show_wind:d.showWind,show_wind_gust:d.showWindGust,show_wind_direction:d.showWindDirection,show_humidity:d.showHumidity,show_min_temp:d.showMinTemp,show_hourly_forecast:d.showHourlyForecast,hourly_forecast_hours:d.hourlyForecastHours,show_daily_forecast:d.showDailyForecast,daily_forecast_days:d.dailyForecastDays,show_sunrise_sunset:d.showSunriseSunset,show_animations:d.showAnimations,show_clock:d.showClock,clock_position:d.clockPosition,clock_format:d.clockFormat,overlay_opacity:d.overlayOpacity,text_shadow:d.textShadow,language:d.language,wind_speed_unit:d.windSpeedUnit,sunrise_entity:"",sunset_entity:"",...i}}updated(i){if(super.updated(i),i.has("hass")){let o=E({hassLang:this.hass?.language});if(u.lang!==o)u.setLanguage(o),this.requestUpdate()}}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:["weather"]}}},{name:"name",selector:{text:{}}},{name:"layout",selector:{select:{options:[{label:u.t("editor.layout_default"),value:"default"},{label:u.t("editor.layout_minimal"),value:"minimal"}]}}},{name:"height",selector:{number:{min:50,max:800,step:10,mode:"box"}}},{name:"show_feels_like",selector:{boolean:{}}},{name:"show_wind",selector:{boolean:{}}},{name:"show_wind_gust",selector:{boolean:{}}},{name:"show_wind_direction",selector:{boolean:{}}},{name:"show_humidity",selector:{boolean:{}}},{name:"show_min_temp",selector:{boolean:{}}},{name:"show_hourly_forecast",selector:{boolean:{}}},{name:"hourly_forecast_hours",selector:{number:{min:1,max:24,step:1,mode:"box"}}},{name:"show_daily_forecast",selector:{boolean:{}}},{name:"daily_forecast_days",selector:{number:{min:1,max:14,step:1,mode:"box"}}},{name:"show_sunrise_sunset",selector:{boolean:{}}},{name:"sunrise_entity",selector:{entity:{domain:["sensor"]}}},{name:"sunset_entity",selector:{entity:{domain:["sensor"]}}},{name:"show_clock",selector:{boolean:{}}},{name:"clock_position",selector:{select:{options:[{label:u.t("editor.clock_position_top"),value:"top"},{label:u.t("editor.clock_position_details"),value:"details"}]}}},{name:"clock_format",selector:{select:{options:[{label:u.t("editor.clock_format_24h"),value:"24h"},{label:u.t("editor.clock_format_12h"),value:"12h"}]}}},{name:"show_animations",selector:{boolean:{}}},{name:"overlay_opacity",selector:{number:{min:0,max:1,step:0.05,mode:"box"}}},{name:"text_shadow",selector:{number:{min:0,max:3,step:1,mode:"box"}}},{name:"language",selector:{select:{options:[{label:u.t("editor.language_auto"),value:"auto"},...Object.keys(T).map((i)=>({label:dn(i),value:i}))]}}},{name:"wind_speed_unit",selector:{select:{options:[{label:u.t("editor.wind_speed_unit_ms"),value:"ms"},{label:u.t("editor.wind_speed_unit_kmh"),value:"kmh"}]}}}]}_computeLabel=(i)=>{let o=`editor.${i.name}`,a=u.t(o);return a===o?i.name:a};_valueChanged(i){let o=i.detail?.value;if(!o)return;this._config=o,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){if(!this.hass)return c``;return c`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${this._schema}
      ...
      ></ha-form>
    `}}m([w({attribute:!1})],Yi.prototype,"hass",void 0),m([di()],Yi.prototype,"_config",void 0);var na={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ea=(i)=>(...o)=>({["_$litDirective$"]:i,values:o});class Oi{constructor(i){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(i,o,a){this.__part=i,this._$parent=o,this.__attributeIndex=a}_$resolve(i,o){return this.update(i,o)}update(i,o){return this.render(...o)}}var cn=!0,xr=cn&&window.ShadyDOM?.inUse&&window.ShadyDOM?.noPatch===!0?window.ShadyDOM.wrap:(i)=>i;var la=(i)=>i.strings===void 0;var gn=!0,ai=(i,o)=>{let a=i._$disconnectableChildren;if(a===void 0)return!1;for(let n of a)n._$notifyDirectiveConnectionChanged?.(o,!1),ai(n,o);return!0},yi=(i)=>{let o,a;do{if((o=i._$parent)===void 0)break;a=o._$disconnectableChildren,a.delete(i),i=o}while(a?.size===0)},ra=(i)=>{for(let o;o=i._$parent;i=o){let a=o._$disconnectableChildren;if(a===void 0)o._$disconnectableChildren=a=new Set;else if(a.has(i))break;a.add(i),kn(o)}};function _n(i){if(this._$disconnectableChildren!==void 0)yi(this),this._$parent=i,ra(this);else this._$parent=i}function hn(i,o=!1,a=0){let n=this._$committedValue,e=this._$disconnectableChildren;if(e===void 0||e.size===0)return;if(o){if(Array.isArray(n))for(let l=a;l<n.length;l++)ai(n[l],!1),yi(n[l]);else if(n!=null)ai(n,!1),yi(n)}else ai(this,i)}var kn=(i)=>{if(i.type==na.CHILD)i._$notifyConnectionChanged??=hn,i._$reparentDisconnectables??=_n};class Xi extends Oi{constructor(){super(...arguments);this._$disconnectableChildren=void 0}_$initialize(i,o,a){super._$initialize(i,o,a),ra(this),this.isConnected=i._$isConnected}["_$notifyDirectiveConnectionChanged"](i,o=!0){if(i!==this.isConnected)if(this.isConnected=i,i)this.reconnected?.();else this.disconnected?.();if(o)ai(this,i),yi(this)}setValue(i){if(la(this.__part))this.__part._$setValue(i,this);else{if(gn&&this.__attributeIndex===void 0)throw Error("Expected this.__attributeIndex to be a number");let o=[...this.__part._$committedValue];o[this.__attributeIndex]=i,this.__part._$setValue(o,this,0)}}disconnected(){}reconnected(){}}class sa extends Xi{_key="";_onLangChange=null;render(i){return this._key=i,u.t(i)}reconnected(){this._onLangChange=()=>{this.setValue(u.t(this._key))},window.addEventListener("language-changed",this._onLangChange)}disconnected(){if(this._onLangChange)window.removeEventListener("language-changed",this._onLangChange)}}var yn=ea(sa);try{customElements.define("dynamic-weather-card",Li),customElements.define("dynamic-weather-card-editor",Yi),console.log(`%cDynamic Weather Card %c${Fo}`,"color: #007AFF; font-weight: bold; font-size: 14px;","color: #666; font-size: 12px;",`
Динамическая карточка погоды`),window.customCards=window.customCards||[];let i={type:"dynamic-weather-card",name:"Dynamic Weather Card",description:"Динамическая карточка погоды",preview:!0,documentationURL:"https://github.com/teuchezh/dynamic-weather-card"};window.customCards.push(i)}catch(i){console.error("❌ Ошибка при регистрации Dynamic Weather Card:",i)}export{yn as t,E as resolveLanguage,u as i18n};
