...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:k,strings:F,values:K}},G=j0(Fk),f=j0(K0),ck=j0(Z0),D=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),a0=new WeakMap,w=P.createTreeWalker(P,129),c=N0;function F1(k,F){if(!M0(k)||!k.hasOwnProperty("raw")){let K="invalid template strings array";throw K=`
