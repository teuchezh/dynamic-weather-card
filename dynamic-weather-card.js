var t=function(k,F,K,Z){var W=arguments.length,q=W<3?F:Z===null?Z=Object.getOwnPropertyDescriptor(F,K):Z,B;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")q=Reflect.decorate(k,F,K,Z);else for(var $=k.length-1;$>=0;$--)if(B=k[$])q=(W<3?B(q):W>3?B(F,K,q):B(F,K))||q;return W>3&&q&&Object.defineProperty(F,K,q),q};var e=globalThis,J0=e.ShadowRoot&&(e.ShadyCSS===void 0||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Q0=Symbol(),O0=new WeakMap;class G0{constructor(k,F,K){if(this._$cssResult$=!0,K!==Q0)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=k,this._strings=F}get styleSheet(){let k=this._styleSheet,F=this._strings;if(J0&&k===void 0){let K=F!==void 0&&F.length===1;if(K)k=O0.get(F);if(k===void 0){if((this._styleSheet=k=new CSSStyleSheet).replaceSync(this.cssText),K)O0.set(F,k)}}return k}toString(){return this.cssText}}var D1=(k)=>{if(k._$cssResult$===!0)return k.cssText;else if(typeof k==="number")return k;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${k}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},g1=(k)=>new G0(typeof k==="string"?k:String(k),void 0,Q0),E0=(k,...F)=>{let K=k.length===1?k[0]:F.reduce((Z,W,q)=>Z+D1(W)+k[q+1],k[0]);return new G0(K,k,Q0)},c0=(k,F)=>{if(J0)k.adoptedStyleSheets=F.map((K)=>K instanceof CSSStyleSheet?K:K.styleSheet);else for(let K of F){let Z=document.createElement("style"),W=e.litNonce;if(W!==void 0)Z.setAttribute("nonce",W);Z.textContent=K.cssText,k.appendChild(Z)}},w1=(k)=>{let F="";for(let K of k.cssRules)F+=K.cssText;return g1(F)},N0=J0?(k)=>k:(k)=>k instanceof CSSStyleSheet?w1(k):k;var{is:P1,defineProperty:O1,getOwnPropertyDescriptor:d0,getOwnPropertyNames:E1,getOwnPropertySymbols:c1,getPrototypeOf:h0}=Object,d1=!1,L=globalThis;if(d1)L.customElements??=customElements;var j=!0,y,u0=L.trustedTypes,h1=u0?u0.emptyScript:"",v0=j?L.reactiveElementPolyfillSupportDevMode:L.reactiveElementPolyfillSupport;if(j)L.litIssuedWarnings??=new Set,y=(k,F)=>{if(F+=` See https://lit.dev/msg/${k} for more information.`,!L.litIssuedWarnings.has(F)&&!L.litIssuedWarnings.has(k))console.warn(F),L.litIssuedWarnings.add(F)},queueMicrotask(()=>{if(y("dev-mode","Lit is in dev mode. Not recommended for production!"),L.ShadyDOM?.inUse&&v0===void 0)y("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var u1=j?(k)=>{if(!L.emitLitDebugLogEvents)return;L.dispatchEvent(new CustomEvent("lit-debug",{detail:k}))}:void 0,O=(k,F)=>k,d={toAttribute(k,F){switch(F){case Boolean:k=k?h1:null;break;case Object:case Array:k=k==null?k:JSON.stringify(k);break}return k},fromAttribute(k,F){let K=k;switch(F){case Boolean:K=k!==null;break;case Number:K=k===null?null:Number(k);break;case Object:case Array:try{K=JSON.parse(k)}catch(Z){K=null}break}return K}},k0=(k,F)=>!P1(k,F),l0={attribute:!0,type:String,converter:d,reflect:!1,useDefault:!1,hasChanged:k0};Symbol.metadata??=Symbol("metadata");L.litPropertyMetadata??=new WeakMap;class X extends HTMLElement{static addInitializer(k){this.__prepare(),(this._initializers??=[]).push(k)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(k,F=l0){if(F.state)F.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(k))F=Object.create(F),F.wrapped=!0;if(this.elementProperties.set(k,F),!F.noAccessor){let K=j?Symbol.for(`${String(k)} (@property() cache)`):Symbol(),Z=this.getPropertyDescriptor(k,K,F);if(Z!==void 0)O1(this.prototype,k,Z)}}static getPropertyDescriptor(k,F,K){let{get:Z,set:W}=d0(this.prototype,k)??{get(){return this[F]},set(q){this[F]=q}};if(j&&Z==null){if("value"in(d0(this.prototype,k)??{}))throw Error(`Field ${JSON.stringify(String(k))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);y("reactive-property-without-getter",`Field ${JSON.stringify(String(k))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:Z,set(q){let B=Z?.call(this);W?.call(this,q),this.requestUpdate(k,B,K)},configurable:!0,enumerable:!0}}static getPropertyOptions(k){return this.elementProperties.get(k)??l0}static __prepare(){if(this.hasOwnProperty(O("elementProperties",this)))return;let k=h0(this);if(k.finalize(),k._initializers!==void 0)this._initializers=[...k._initializers];this.elementProperties=new Map(k.elementProperties)}static finalize(){if(this.hasOwnProperty(O("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(O("properties",this))){let F=this.properties,K=[...E1(F),...c1(F)];for(let Z of K)this.createProperty(Z,F[Z])}let k=this[Symbol.metadata];if(k!==null){let F=litPropertyMetadata.get(k);if(F!==void 0)for(let[K,Z]of F)this.elementProperties.set(K,Z)}this.__attributeToPropertyMap=new Map;for(let[F,K]of this.elementProperties){let Z=this.__attributeNameForProperty(F,K);if(Z!==void 0)this.__attributeToPropertyMap.set(Z,F)}if(this.elementStyles=this.finalizeStyles(this.styles),j){if(this.hasOwnProperty("createProperty"))y("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))y("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(k){let F=[];if(Array.isArray(k)){let K=new Set(k.flat(1/0).reverse());for(let Z of K)F.unshift(N0(Z))}else if(k!==void 0)F.push(N0(k));return F}static __attributeNameForProperty(k,F){let K=F.attribute;return K===!1?void 0:typeof K==="string"?K:typeof k==="string"?k.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((k)=>this.enableUpdating=k),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((k)=>k(this))}addController(k){if((this.__controllers??=new Set).add(k),this.renderRoot!==void 0&&this.isConnected)k.hostConnected?.()}removeController(k){this.__controllers?.delete(k)}__saveInstanceProperties(){let k=new Map,F=this.constructor.elementProperties;for(let K of F.keys())if(this.hasOwnProperty(K))k.set(K,this[K]),delete this[K];if(k.size>0)this.__instanceProperties=k}createRenderRoot(){let k=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return c0(k,this.constructor.elementStyles),k}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((k)=>k.hostConnected?.())}enableUpdating(k){}disconnectedCallback(){this.__controllers?.forEach((k)=>k.hostDisconnected?.())}attributeChangedCallback(k,F,K){this._$attributeToProperty(k,K)}__propertyToAttribute(k,F){let Z=this.constructor.elementProperties.get(k),W=this.constructor.__attributeNameForProperty(k,Z);if(W!==void 0&&Z.reflect===!0){let B=(Z.converter?.toAttribute!==void 0?Z.converter:d).toAttribute(F,Z.type);if(j&&this.constructor.enabledWarnings.includes("migration")&&B===void 0)y("undefined-attribute-value",`The attribute value for the ${k} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=k,B==null)this.removeAttribute(W);else this.setAttribute(W,B);this.__reflectingProperty=null}}_$attributeToProperty(k,F){let K=this.constructor,Z=K.__attributeToPropertyMap.get(k);if(Z!==void 0&&this.__reflectingProperty!==Z){let W=K.getPropertyOptions(Z),q=typeof W.converter==="function"?{fromAttribute:W.converter}:W.converter?.fromAttribute!==void 0?W.converter:d;this.__reflectingProperty=Z;let B=q.fromAttribute(F,W.type);this[Z]=B??this.__defaultValues?.get(Z)??B,this.__reflectingProperty=null}}requestUpdate(k,F,K,Z=!1,W){if(k!==void 0){if(j&&k instanceof Event)y("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let q=this.constructor;if(Z===!1)W=this[k];if(K??=q.getPropertyOptions(k),(K.hasChanged??k0)(W,F)||K.useDefault&&K.reflect&&W===this.__defaultValues?.get(k)&&!this.hasAttribute(q.__attributeNameForProperty(k,K)))this._$changeProperty(k,F,K);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(k,F,{useDefault:K,reflect:Z,wrapped:W},q){if(K&&!(this.__defaultValues??=new Map).has(k)){if(this.__defaultValues.set(k,q??F??this[k]),W!==!0||q!==void 0)return}if(!this._$changedProperties.has(k)){if(!this.hasUpdated&&!K)F=void 0;this._$changedProperties.set(k,F)}if(Z===!0&&this.__reflectingProperty!==k)(this.__reflectingProperties??=new Set).add(k)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(F){Promise.reject(F)}let k=this.scheduleUpdate();if(k!=null)await k;return!this.isUpdatePending}scheduleUpdate(){let k=this.performUpdate();if(j&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof k?.then==="function")y("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return k}performUpdate(){if(!this.isUpdatePending)return;if(u1?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),j){let W=[...this.constructor.elementProperties.keys()].filter((q)=>this.hasOwnProperty(q)&&(q in h0(this)));if(W.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${W.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[Z,W]of this.__instanceProperties)this[Z]=W;this.__instanceProperties=void 0}let K=this.constructor.elementProperties;if(K.size>0)for(let[Z,W]of K){let{wrapped:q}=W,B=this[Z];if(q===!0&&!this._$changedProperties.has(Z)&&B!==void 0)this._$changeProperty(Z,void 0,W,B)}}let k=!1,F=this._$changedProperties;try{if(k=this.shouldUpdate(F),k)this.willUpdate(F),this.__controllers?.forEach((K)=>K.hostUpdate?.()),this.update(F);else this.__markUpdated()}catch(K){throw k=!1,this.__markUpdated(),K}if(k)this._$didUpdate(F)}willUpdate(k){}_$didUpdate(k){if(this.__controllers?.forEach((F)=>F.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(k);if(this.updated(k),j&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))y("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(k){return!0}update(k){this.__reflectingProperties&&=this.__reflectingProperties.forEach((F)=>this.__propertyToAttribute(F,this[F])),this.__markUpdated()}updated(k){}firstUpdated(k){}}X.elementStyles=[];X.shadowRootOptions={mode:"open"};X[O("elementProperties",X)]=new Map;X[O("finalized",X)]=new Map;v0?.({ReactiveElement:X});if(j){X.enabledWarnings=["change-in-update","async-perform-update"];let k=function(F){if(!F.hasOwnProperty(O("enabledWarnings",F)))F.enabledWarnings=F.enabledWarnings.slice()};X.enableWarning=function(F){if(k(this),!this.enabledWarnings.includes(F))this.enabledWarnings.push(F)},X.disableWarning=function(F){k(this);let K=this.enabledWarnings.indexOf(F);if(K>=0)this.enabledWarnings.splice(K,1)}}(L.reactiveElementVersions??=[]).push("2.1.2");if(j&&L.reactiveElementVersions.length>1)queueMicrotask(()=>{y("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var Y=globalThis,G=(k)=>{if(!Y.emitLitDebugLogEvents)return;Y.dispatchEvent(new CustomEvent("lit-debug",{detail:k}))},l1=0,l;Y.litIssuedWarnings??=new Set,l=(k,F)=>{if(F+=k?` See https://lit.dev/msg/${k} for more information.`:"",!Y.litIssuedWarnings.has(F)&&!Y.litIssuedWarnings.has(k))console.warn(F),Y.litIssuedWarnings.add(F)},queueMicrotask(()=>{l("dev-mode","Lit is in dev mode. Not recommended for production!")});var V=Y.ShadyDOM?.inUse&&Y.ShadyDOM?.noPatch===!0?Y.ShadyDOM.wrap:(k)=>k,F0=Y.trustedTypes,m0=F0?F0.createPolicy("lit-html",{createHTML:(k)=>k}):void 0,v1=(k)=>k,q0=(k,F,K)=>v1,m1=(k)=>{if(P!==q0)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");P=k},p1=()=>{P=q0},A0=(k,F,K)=>{return P(k,F,K)},a0="$lit$",z=`lit$${Math.random().toFixed(9).slice(2)}$`,t0="?"+z,o1=`<${t0}>`,g=document,v=()=>g.createComment(""),m=(k)=>k===null||typeof k!="object"&&typeof k!="function",b0=Array.isArray,r1=(k)=>b0(k)||typeof k?.[Symbol.iterator]==="function",_0=`[ 	
\f\r]`,i1=`[^ 	
\f\r"'\`<>=]`,s1=`[^\\s"'>=/]`,h=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,p0=1,H0=2,n1=3,o0=/-->/g,r0=/>/g,I=new RegExp(`>|${_0}(?:(${s1}+)(${_0}*=${_0}*(?:${i1}|("|')|))|$)`,"g"),a1=0,i0=1,t1=2,s0=3,f0=/'/g,U0=/"/g,e0=/^(?:script|style|textarea|title)$/i,e1=1,K0=2,Z0=3,M0=1,W0=2,kk=3,Fk=4,Kk=5,L0=6,Zk=7,j0=(k)=>(F,...K)=>{if(F.some((Z)=>Z===void 0))console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`);if(K.some((Z)=>Z?._$litStatic$))l("",`Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:k,strings:F,values:K}},A=j0(e1),N=j0(K0),gk=j0(Z0),w=Symbol.for("lit-noChange"),H=Symbol.for("lit-nothing"),n0=new WeakMap,D=g.createTreeWalker(g,129),P=q0;function k1(k,F){if(!b0(k)||!k.hasOwnProperty("raw")){let K="invalid template strings array";throw K=`
...
`,Xk={sunny:N`
  ...
  `};function n(k,...F){let K=jk[k];if(typeof K==="function")return K(...F);return K||""}function V1(k){if(!k)return"";return Xk[k.toLowerCase()]||""}class g0 extends R{animationFrame=null;canvas=null;ctx=null;canvasWidth=0;canvasHeight=0;animations={};holdTimer=null;holdDelay=500;clockInterval=null;resizeObserver=null;_wheelHandler=null;lastTap=null;holdFired=!1;_testTimeOfDay;static get styles(){return Y1}constructor(){super();this.currentTime="";this.config={}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{setTimeout(()=>{if(this.setupCanvas(),this.canvas&&this.ctx)this.initializeAnimations(),this.startAnimation(),this.setupResizeObserver();this.setupForecastScroll(),this.startClock()},100)})}disconnectedCallback(){if(super.disconnectedCallback(),this.animationFrame)cancelAnimationFrame(this.animationFrame),this.animationFrame=null;if(this.resizeObserver)this.resizeObserver.disconnect(),this.resizeObserver=null;if(this._wheelHandler&&this.shadowRoot){let k=this.shadowRoot.querySelector(".forecast-scroll");if(k)k.removeEventListener("wheel",this._wheelHandler);this._wheelHandler=null}if(this.clockInterval)clearInterval(this.clockInterval),this.clockInterval=null}updated(k){if(super.updated(k),k.has("hass")||k.has("config")){if(this.canvas&&this.ctx)this.resizeCanvas();this.setupForecastScroll()}let F=y0({configLang:this.config?.language,hassLang:this.hass?.language});if(b.lang!==F)b.setLanguage(F)}initializeAnimations(){if(!this.ctx)return;this.animations={sunny:new C0(this.ctx),rainy:new s(this.ctx),snowy:new z0(this.ctx),cloudy:new S0(this.ctx),foggy:new I0(this.ctx),hail:new R0(this.ctx),thunderstorm:new D0(this.ctx)}}setupResizeObserver(){if(!this.shadowRoot)return;let k=this.shadowRoot.querySelector(".canvas-container");if(!k)return;this.resizeObserver=new ResizeObserver(()=>{this.resizeCanvas()}),this.resizeObserver.observe(k)}setupForecastScroll(){if(!this.shadowRoot)return;let k=this.shadowRoot.querySelector(".forecast-scroll");if(!k)return;if(this._wheelHandler)k.removeEventListener("wheel",this._wheelHandler);this._wheelHandler=(F)=>{let K=F;if(K.deltaY!==0)F.preventDefault(),k.scrollLeft+=K.deltaY},k.addEventListener("wheel",this._wheelHandler,{passive:!1})}resizeCanvas(){if(!this.canvas||!this.shadowRoot)return;let k=this.shadowRoot.querySelector(".canvas-container");if(!k)return;let F=k.getBoundingClientRect();if(F.width===0||F.height===0)return;let K=window.devicePixelRatio||2;if(this.canvas.width=F.width*K,this.canvas.height=F.height*K,this.canvas.style.width="100%",this.canvas.style.height="100%",this.ctx=this.canvas.getContext("2d"),this.ctx)this.ctx.scale(K,K);this.canvasWidth=F.width,this.canvasHeight=F.height,this.initializeAnimations()}setupCanvas(){if(!this.shadowRoot)return;let k=this.shadowRoot.querySelector(".canvas-container");if(!k)return;let F=k.querySelector("canvas");if(F)F.remove();this.canvas=document.createElement("canvas"),k.appendChild(this.canvas),this.resizeCanvas()}getState(k){if(!this.hass||!k)return null;let F=this.hass.states[k];return F?F.state:null}getAttributes(k){if(!this.hass||!k)return{};let F=this.hass.states[k];return F?F.attributes:{}}getWeatherData(){let k=this.config.entity||"weather.home",F=this.getState(k),K=this.getAttributes(k),Z=K.condition||F||"sunny",W=null;if(this.config.templowAttribute&&K[this.config.templowAttribute]!=null)W=K[this.config.templowAttribute];else{for(let q of N1)if(K[q]!=null){W=K[q];break}if(W==null)W=(K.forecast&&K.forecast[0]?K.forecast[0].templow??null:null)||(K.forecast_hourly&&K.forecast_hourly[0]?K.forecast_hourly[0].native_templow??null:null)}return{condition:Z,temperature:K.temperature!=null?K.temperature:null,apparentTemperature:K.apparent_temperature||null,humidity:K.humidity!=null?K.humidity:null,windSpeed:K.wind_speed!=null?K.wind_speed:null,windGust:K.wind_gust_speed||K.wind_gust||null,windBearing:K.wind_bearing!=null?K.wind_bearing:null,windDirection:K.wind_direction||null,pressure:K.pressure||null,forecast:K.forecast||K.forecast_hourly||[],friendlyName:K.friendly_name||b.t("weather"),templow:W}}getTodayForecast(){if(!this.hass||!this.config)return[];let k=this.getWeatherData();if(!k.forecast||k.forecast.length===0)return[];let F=new Date,K=new Date(F.getFullYear(),F.getMonth(),F.getDate()),Z=new Date(K);return Z.setDate(Z.getDate()+1),k.forecast.filter((q)=>{if(!q.datetime)return!1;let B=new Date(q.datetime),$=new Date(B.getFullYear(),B.getMonth(),B.getDate());return $.getTime()===K.getTime()||$.getTime()===Z.getTime()&&B.getHours()<=F.getHours()}).sort((q,B)=>new Date(q.datetime).getTime()-new Date(B.datetime).getTime()).slice(0,8)}startAnimation(){let k=()=>{this.draw(),this.animationFrame=requestAnimationFrame(k)};k()}draw(){if(!this.ctx||!this.canvas)return;if(!this.canvasWidth||!this.canvasHeight){if(this.resizeCanvas(),!this.canvasWidth||!this.canvasHeight)return}let k=this.canvasWidth,F=this.canvasHeight;this.ctx.clearRect(0,0,k,F);let K=this.getWeatherData(),Z=this.hass?.states[this.config.entity],W=x0(Z||{},this.config.sunriseEntity,this.config.sunsetEntity,this.hass),q=this._testTimeOfDay||T0(W);switch(K.condition.toLowerCase()){case"sunny":case"clear":this.animations.sunny?.draw(Date.now(),k,F,q);break;case"clear-night":this.animations.sunny?.draw(Date.now(),k,F,{type:"night",progress:0});break;case"rainy":case"rain":this.animations.rainy?.draw(Date.now(),k,F,q,!1);break;case"pouring":this.animations.rainy?.draw(Date.now(),k,F,q,!0);break;case"snowy":case"snow":this.animations.snowy?.draw(Date.now(),k,F,q);break;case"snowy-rainy":this.animations.rainy?.draw(Date.now(),k,F,q,!1),this.animations.snowy?.draw(Date.now(),k,F,q);break;case"hail":this.animations.hail?.draw(Date.now(),k,F,q);break;case"foggy":case"fog":this.animations.foggy?.draw(Date.now(),k,F,q);break;case"lightning":this.animations.thunderstorm?.draw(Date.now(),k,F,q,!1);break;case"lightning-rainy":this.animations.thunderstorm?.draw(Date.now(),k,F,q,!0);break;case"cloudy":case"partlycloudy":default:this.animations.cloudy?.draw(Date.now(),k,F,q);break}}renderTodayForecast(){let k=this.getTodayForecast();if(k.length===0)return A`<div style="opacity: 0.6; font-size: 14px;">${b.t("forecast_unavailable")}</div>`;return A`
      <div class="forecast-scroll">
        ${k.map((F)=>A`
          <div class="forecast-item">
            <div class="forecast-time">${X1(F.datetime)}</div>
            <div class="forecast-icon">${V1(F.condition||"sunny")}</div>
            <div class="forecast-temp">${Math.round(F.temperature||F.temp||F.native_temperature||0)}°</div>
          </div>
        `)}
      </div>
    `}convertWindSpeed(k){if(k==null)return null;if(this.config.windSpeedUnit==="kmh")return Math.round(k*3.6*10)/10;return k}getWindSpeedUnit(){return this.config.windSpeedUnit==="kmh"?b.t("wind_unit_kmh"):b.t("wind_unit_ms")}formatCurrentTime(){let k=new Date,F=String(k.getHours()).padStart(2,"0"),K=String(k.getMinutes()).padStart(2,"0");return`${F}:${K}`}startClock(){if(!this.config.showClock)return;this.currentTime=this.formatCurrentTime(),this.clockInterval=window.setInterval(()=>{this.currentTime=this.formatCurrentTime()},1000)}render(){if(!this.hass)return A`<div>No Home Assistant connection</div>`;let k=this.getWeatherData(),F=this.hass.states[this.config.entity],K=x0(F,this.config.sunriseEntity,this.config.sunsetEntity,this.hass),Z=this._testTimeOfDay||T0(K),W=`weather-card ${Z.type}`,q=this.config.height?`${this.config.height}px`:"200px",B=j1(Z),$=B?`background: linear-gradient(135deg, rgb(${B.start.r}, ${B.start.g}, ${B.start.b}), rgb(${B.end.r}, ${B.end.g}, ${B.end.b}));`:"",_=`--overlay-opacity: ${this.config.overlayOpacity!==void 0?this.config.overlayOpacity:c.overlayOpacity};`;return A`
      <ha-card
      ...
      >
        <div class="${W}" style="min-height: ${q}; ${$}; ${_} cursor: pointer;">
          <div class="canvas-container"></div>
          <div class="content">
            ${this.config.name!==void 0?A`
              <div class="header">
                <div class="location">${this.config.name||k.friendlyName}</div>
              </div>
            `:""}
            <div>
<div class="condition">${b.t(k.condition)}</div>
              <div class="temperature">${k.temperature!=null?Math.round(k.temperature)+"°":b.t("no_data")}</div>
              ${this.config.showMinTemp&&k.templow?A`
                <div class="temp-range">
                  <span class="temp-min">↓ ${Math.round(k.templow)}°</span>
                </div>
              `:""}
              ${this.config.showFeelsLike&&k.apparentTemperature?A`
<div class="feels-like">${b.t("feels_like")} ${Math.round(k.apparentTemperature)}°</div>
              `:""}
            </div>
            <div class="details">
              <div class="info-grid">
                ${this.config.showHumidity&&k.humidity!=null?A`
                  <div class="info-item">
                    <span class="info-icon">${n("humidity")}</span>
                    <span>${k.humidity} %</span>
                  </div>
                `:""}
                ${this.config.showSunriseSunset&&K.hasSunData&&K.sunrise?A`
                  <div class="info-item">
                    <span class="info-icon">${n("sunrise")}</span>
                    <span>${V0(K.sunrise)}</span>
                  </div>
                `:""}
                ${this.config.showWind&&k.windSpeed!=null?A`
                  ${this.config.showWindDirection&&k.windBearing!=null?A`
                    <div class="info-item">
                      <span class="info-icon">${y1(k.windBearing)}</span>
                  ...
                  `}
                `:""}
                ${this.config.showSunriseSunset&&K.hasSunData&&K.sunset?A`
                  <div class="info-item">
...
<div class="forecast-title">${b.t("forecast_title")}</div>
          ...
          ${this.config.showClock?A`
            <div class="clock">${this.currentTime}</div>
          `:""}
        </div>
      </ha-card>
    `}setConfig(k){if(!k.entity)throw Error("Please define a weather entity");if(this.config={type:"custom:animated-weather-card",entity:k.entity,icons_path:k.icons_path,name:k.name,height:k.height||c.height,showFeelsLike:k.show_feels_like!==!1,showWind:k.show_wind!==!1,showWindGust:k.show_wind_gust!==!1,showWindDirection:k.show_wind_direction!==!1,showHumidity:k.show_humidity!==!1,showMinTemp:k.show_min_temp!==!1,showForecast:k.show_forecast===!0,showSunriseSunset:k.show_sunrise_sunset!==!1,showClock:k.show_clock===!0,overlayOpacity:k.overlay_opacity!==void 0?k.overlay_opacity:c.overlayOpacity,language:k.language||c.language,windSpeedUnit:k.wind_speed_unit||c.windSpeedUnit,sunriseEntity:k.sunrise_entity||null,sunsetEntity:k.sunset_entity||null,templowAttribute:k.templow_attribute||null,tapAction:k.tap_action||{action:"more-info"},holdAction:k.hold_action||{action:"none"},doubleTapAction:k.double_tap_action||{action:"none"}},this.config.language)b.setLanguage(this.config.language)}handleAction(k){if(!k||!this.hass)return;switch(k.action||"more-info"){case"more-info":this.fireEvent("hass-more-info",{entityId:k.entity||this.config.entity});break;case"toggle":this.hass.callService("homeassistant","toggle",{entity_id:k.entity||this.config.entity});break;case"call-service":if(k.service){let[K,Z]=k.service.split(".");this.hass.callService(K,Z,k.service_data||{})}break;case"navigate":if(k.navigation_path)window.history.pushState(null,"",k.navigation_path),this.fireEvent("location-changed",{replace:!1});break;case"url":if(k.url_path)window.open(k.url_path);break;case"none":default:break}}fireEvent(k,F={}){let K=new CustomEvent(k,{detail:F,bubbles:!0,composed:!0});this.dispatchEvent(K)}handleTap(k){if(k.target.closest(".forecast-item")||k.target.closest(".info-item"))return;if(this.lastTap&&Date.now()-this.lastTap<300){this.handleDoubleTap(k),this.lastTap=null;return}this.lastTap=Date.now(),setTimeout(()=>{if(this.lastTap)this.handleAction(this.config.tapAction),this.lastTap=null},300)}handlePointerDown(k){this.holdTimer=window.setTimeout(()=>{this.handleHold(k),this.holdFired=!0},this.holdDelay)}handlePointerUp(k){if(this.holdTimer)clearTimeout(this.holdTimer);if(this.holdFired)k.preventDefault(),k.stopPropagation(),this.holdFired=!1}handleHold(k){this.handleAction(this.config.holdAction)}handleDoubleTap(k){this.handleAction(this.config.doubleTapAction)}getCardSize(){return 1}}t([i({type:Object})],g0.prototype,"hass",void 0),t([i({type:Object})],g0.prototype,"config",void 0),t([Q1()],g0.prototype,"currentTime",void 0);var x1={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},T1=(k)=>(...F)=>({["_$litDirective$"]:k,values:F});class w0{constructor(k){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(k,F,K){this.__part=k,this._$parent=F,this.__attributeIndex=K}_$resolve(k,F){return this.update(k,F)}update(k,F){return this.render(...F)}}var Yk=!0,C2=Yk&&window.ShadyDOM?.inUse&&window.ShadyDOM?.noPatch===!0?window.ShadyDOM.wrap:(k)=>k;var C1=(k)=>k.strings===void 0;var yk=!0,a=(k,F)=>{let K=k._$disconnectableChildren;if(K===void 0)return!1;for(let Z of K)Z._$notifyDirectiveConnectionChanged?.(F,!1),a(Z,F);return!0},$0=(k)=>{let F,K;do{if((F=k._$parent)===void 0)break;K=F._$disconnectableChildren,K.delete(k),k=F}while(K?.size===0)},z1=(k)=>{for(let F;F=k._$parent;k=F){let K=F._$disconnectableChildren;if(K===void 0)F._$disconnectableChildren=K=new Set;else if(K.has(k))break;K.add(k),Tk(F)}};function Vk(k){if(this._$disconnectableChildren!==void 0)$0(this),this._$parent=k,z1(this);else this._$parent=k}function xk(k,F=!1,K=0){let Z=this._$committedValue,W=this._$disconnectableChildren;if(W===void 0||W.size===0)return;if(F){if(Array.isArray(Z))for(let q=K;q<Z.length;q++)a(Z[q],!1),$0(Z[q]);else if(Z!=null)a(Z,!1),$0(Z)}else a(this,k)}var Tk=(k)=>{if(k.type==x1.CHILD)k._$notifyConnectionChanged??=xk,k._$reparentDisconnectables??=Vk};class P0 extends w0{constructor(){super(...arguments);this._$disconnectableChildren=void 0}_$initialize(k,F,K){super._$initialize(k,F,K),z1(this),this.isConnected=k._$isConnected}["_$notifyDirectiveConnectionChanged"](k,F=!0){if(k!==this.isConnected)if(this.isConnected=k,k)this.reconnected?.();else this.disconnected?.();if(F)a(this,k),$0(this)}setValue(k){if(C1(this.__part))this.__part._$setValue(k,this);else{if(yk&&this.__attributeIndex===void 0)throw Error("Expected this.__attributeIndex to be a number");let F=[...this.__part._$committedValue];F[this.__attributeIndex]=k,this.__part._$setValue(F,this,0)}}disconnected(){}reconnected(){}}class S1 extends P0{_key="";_onLangChange=null;render(k){return this._key=k,b.t(k)}connected(){this._onLangChange=()=>{this.setValue(b.t(this._key))},window.addEventListener("language-changed",this._onLangChange)}disconnected(){if(this._onLangChange)window.removeEventListener("language-changed",this._onLangChange)}}var Ck=T1(S1);try{customElements.define("dynamic-weather-card",g0),console.log(`%cDynamic Weather Card %c${G1}`,"color: #007AFF; font-weight: bold; font-size: 14px;","color: #666; font-size: 12px;",`
Динамическая карточка погоды`),window.customCards=window.customCards||[];let k={type:"dynamic-weather-card",name:"Dynamic Weather Card",description:"Динамическая карточка погоды",preview:!0,documentationURL:"https://github.com/teuchezh/dynamic-weather-card"};window.customCards.push(k)}catch(k){console.error("❌ Ошибка при регистрации Dynamic Weather Card:",k)}export{Ck as t,y0 as resolveLanguage,b as i18n};
