...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:o,strings:i,values:c}},w=$o(Fc),u=$o(no),tc=$o(_o),T=Symbol.for("lit-noChange"),A=Symbol.for("lit-nothing"),ai=new WeakMap,S=z.createTreeWalker(z,129),P=ao;function ki(o,i){if(!mo(o)||!o.hasOwnProperty("raw")){let c="invalid template strings array";throw c=`
...
`,Vc={sunny:u`
  ...
  `};function t(o,...i){let c=jc[o];if(typeof c==="function")return c(...i);return c||""}function ko(o){if(!o)return"";return Vc[o.toLowerCase()]||""}class ji extends Z{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null}static styles=C`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return w``;return w`
    ...
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return w``;let o=this.entityAttributes||{},i=po(this.weather.windSpeed,o,this.config.windSpeedUnit),c=Gi(o,this.config.windSpeedUnit,h.t.bind(h)),l="";if(this.config.showWindGust&&this.weather.windGust)l=` / ${po(this.weather.windGust,o,this.config.windSpeedUnit)} ${c}`;let n=this.config.showWindDirection&&this.weather.windBearing!=null?Pi(this.weather.windBearing):t("wind");return w`
      <div class="info-item">
    ...
    `}}F([b({type:Object})],ji.prototype,"weather",void 0),F([b({type:Object})],ji.prototype,"sunData",void 0),F([b({type:Object})],ji.prototype,"config",void 0),F([b({type:Object})],ji.prototype,"entityAttributes",void 0);customElements.define("weather-details",ji);var fo=C`
  :host {
    display: block;
  }
...
`;class Vi extends Z{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=fo;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=go(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return w``;return w`
    ...
    `}}F([b({type:Object})],Ro.prototype,"hass",void 0),F([b({type:Object})],Ro.prototype,"config",void 0);class Lo extends Z{constructor(){super(...arguments);this._config={}}setConfig(o){this._config={name:"",height:k.height,show_feels_like:k.showFeelsLike,show_wind:k.showWind,show_wind_gust:k.showWindGust,show_wind_direction:k.showWindDirection,show_humidity:k.showHumidity,show_min_temp:k.showMinTemp,show_hourly_forecast:k.showHourlyForecast,hourly_forecast_hours:k.hourlyForecastHours,show_daily_forecast:k.showDailyForecast,daily_forecast_days:k.dailyForecastDays,show_sunrise_sunset:k.showSunriseSunset,show_clock:k.showClock,clock_position:k.clockPosition,clock_format:k.clockFormat,overlay_opacity:k.overlayOpacity,language:k.language,wind_speed_unit:k.windSpeedUnit,sunrise_entity:"",sunset_entity:"",...o}}updated(o){if(super.updated(o),o.has("hass")){let i=e({hassLang:this.hass?.language});if(h.lang!==i)h.setLanguage(i),this.requestUpdate()}}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:["weather"]}}},{name:"name",selector:{text:{}}},{name:"height",selector:{number:{min:200,max:800,step:10,mode:"box"}}},{name:"show_feels_like",selector:{boolean:{}}},{name:"show_wind",selector:{boolean:{}}},{name:"show_wind_gust",selector:{boolean:{}}},{name:"show_wind_direction",selector:{boolean:{}}},{name:"show_humidity",selector:{boolean:{}}},{name:"show_min_temp",selector:{boolean:{}}},{name:"show_hourly_forecast",selector:{boolean:{}}},{name:"hourly_forecast_hours",selector:{number:{min:1,max:24,step:1,mode:"box"}}},{name:"show_daily_forecast",selector:{boolean:{}}},{name:"daily_forecast_days",selector:{number:{min:1,max:14,step:1,mode:"box"}}},{name:"show_sunrise_sunset",selector:{boolean:{}}},{name:"sunrise_entity",selector:{entity:{domain:["sensor"]}}},{name:"sunset_entity",selector:{entity:{domain:["sensor"]}}},{name:"show_clock",selector:{boolean:{}}},{name:"clock_position",selector:{select:{options:[{label:h.t("editor.clock_position_top"),value:"top"},{label:h.t("editor.clock_position_details"),value:"details"}]}}},{name:"clock_format",selector:{select:{options:[{label:h.t("editor.clock_format_24h"),value:"24h"},{label:h.t("editor.clock_format_12h"),value:"12h"}]}}},{name:"overlay_opacity",selector:{number:{min:0,max:1,step:0.05,mode:"box"}}},{name:"language",selector:{select:{options:[{label:h.t("editor.language_auto"),value:"auto"},{label:h.t("editor.language_en"),value:"en"},{label:h.t("editor.language_ru"),value:"ru"},{label:h.t("editor.language_de"),value:"de"},{label:h.t("editor.language_nl"),value:"nl"},{label:h.t("editor.language_fr"),value:"fr"},{label:h.t("editor.language_es"),value:"es"}]}}},{name:"wind_speed_unit",selector:{select:{options:[{label:h.t("editor.wind_speed_unit_ms"),value:"ms"},{label:h.t("editor.wind_speed_unit_kmh"),value:"kmh"}]}}}]}_computeLabel=(o)=>{let i=`editor.${o.name}`,c=h.t(i);return c===i?o.name:c};_valueChanged(o){let i=o.detail?.value;if(!i)return;this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){if(!this.hass)return w``;return w`
      ...
      ></ha-form>
    `}}F([b({attribute:!1})],Lo.prototype,"hass",void 0),F([ho()],Lo.prototype,"_config",void 0);var Yi={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ui=(o)=>(...i)=>({["_$litDirective$"]:o,values:i});class Do{constructor(o){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(o,i,c){this.__part=o,this._$parent=i,this.__attributeIndex=c}_$resolve(o,i){return this.update(o,i)}update(o,i){return this.render(...i)}}var Xc=!0,t_=Xc&&window.ShadyDOM?.inUse&&window.ShadyDOM?.noPatch===!0?window.ShadyDOM.wrap:(o)=>o;var Ri=(o)=>o.strings===void 0;var Yc=!0,oo=(o,i)=>{let c=o._$disconnectableChildren;if(c===void 0)return!1;for(let l of c)l._$notifyDirectiveConnectionChanged?.(i,!1),oo(l,i);return!0},wo=(o)=>{let i,c;do{if((i=o._$parent)===void 0)break;c=i._$disconnectableChildren,c.delete(o),o=i}while(c?.size===0)},Li=(o)=>{for(let i;i=o._$parent;o=i){let c=i._$disconnectableChildren;if(c===void 0)i._$disconnectableChildren=c=new Set;else if(c.has(o))break;c.add(o),Lc(i)}};function Uc(o){if(this._$disconnectableChildren!==void 0)wo(this),this._$parent=o,Li(this);else this._$parent=o}function Rc(o,i=!1,c=0){let l=this._$committedValue,n=this._$disconnectableChildren;if(n===void 0||n.size===0)return;if(i){if(Array.isArray(l))for(let _=c;_<l.length;_++)oo(l[_],!1),wo(l[_]);else if(l!=null)oo(l,!1),wo(l)}else oo(this,o)}var Lc=(o)=>{if(o.type==Yi.CHILD)o._$notifyConnectionChanged??=Rc,o._$reparentDisconnectables??=Uc};class vo extends Do{constructor(){super(...arguments);this._$disconnectableChildren=void 0}_$initialize(o,i,c){super._$initialize(o,i,c),Li(this),this.isConnected=o._$isConnected}["_$notifyDirectiveConnectionChanged"](o,i=!0){if(o!==this.isConnected)if(this.isConnected=o,o)this.reconnected?.();else this.disconnected?.();if(i)oo(this,o),wo(this)}setValue(o){if(Ri(this.__part))this.__part._$setValue(o,this);else{if(Yc&&this.__attributeIndex===void 0)throw Error("Expected this.__attributeIndex to be a number");let i=[...this.__part._$committedValue];i[this.__attributeIndex]=o,this.__part._$setValue(i,this,0)}}disconnected(){}reconnected(){}}class Di extends vo{_key="";_onLangChange=null;render(o){return this._key=o,h.t(o)}reconnected(){this._onLangChange=()=>{this.setValue(h.t(this._key))},window.addEventListener("language-changed",this._onLangChange)}disconnected(){if(this._onLangChange)window.removeEventListener("language-changed",this._onLangChange)}}var Dc=Ui(Di);try{customElements.define("dynamic-weather-card",Ro),customElements.define("dynamic-weather-card-editor",Lo),console.log(`%cDynamic Weather Card %c${Ki}`,"color: #007AFF; font-weight: bold; font-size: 14px;","color: #666; font-size: 12px;",`
